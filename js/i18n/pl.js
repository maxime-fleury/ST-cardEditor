...
export default {
  ...
  'settings.promptVariables': 'Dostępne zmienne promptu',
  'settings.varCard': 'Wstawia bieżącą kartę jako JSON do promptu.',
  'settings.varLang': 'Język docelowy dla szybkiej akcji Tłumacz.',
  'settings.varTone': 'Ton wybrany w szybkiej akcji Ton.',
  'settings.varCount': 'Liczba elementów do wygenerowania (np. alternatywne powitania).',
  'settings.varCurrent': 'Bieżąca zawartość edytowanego pola.',
  'settings.varField': 'Nazwa edytowanego pola.',
  'settings.varChar': 'Imię postaci, podstawiane przez silnik czatu (SillyTavern).',
  'settings.varUser': 'Nazwa użytkownika, podstawiana przez silnik czatu (SillyTavern).',
  'ai.thinkingLive': 'Myślenie… {{secs}}',
  'ai.streamLive': '{{tokens}} tokenów · {{secs}}',
  'dialog.ok': 'Dobrze',
  'editor.extensions': 'Rozszerzenia (JSON)',
  'editor.extensionsHint': 'Surowy obiekt `extensions` karty — JSON. Jego edycja może zepsuć funkcje SillyTavern.',
  'editor.extensionsParseError': 'Nieprawidłowy JSON — zachowuję ostatnie poprawne rozszerzenia.',
  'editor.cardTokenTotal': '~{{tokens}} tokenów · {{chars}} znaków',
  ...
  'settings.modelAuto': 'Automatycznie',
  ...
  'wizard.language.en': 'Angielski',
  'wizard.language.fr': 'Francuski',
  'wizard.language.de': 'Niemiecki',
  'wizard.language.ja': 'Japoński',
  'wizard.language.it': 'Włoski',
  'wizard.language.pl': 'Polski',
  'wizard.language.tr': 'Turecki',
  'wizard.language.nl': 'Niderlandzki',
  'wizard.language.uk': 'Ukraiński',
  'wizard.language.vi': 'Wietnamski',
  'wizard.language.id': 'Indonezyjski',
  'wizard.language.hi': 'Hindi',
  'wizard.language.ar': 'Arabski',
  'wizard.language.he': 'Hebrajski',
  'wizard.language.fa': 'Perski',
  'wizard.language.ro': 'Rumuński',
  'wizard.language.cs': 'Czeski',
  'wizard.language.sv': 'Szwedzki',
  'wizard.language.th': 'Tajski',
  'wizard.language.pt-pt': 'Portugalski (Portugalia)',
  'wizard.language.tl': 'Filipiński',
  'search.results': '{{count}} pasujących kart',
  'search.capped': 'Pokazano pierwszych {{count}} wyników — zawęź wyszukiwanie',
  'shortcuts.palette': 'Paleta poleceń',
  'library.reorderHandle': 'Zmień kolejność karty (strzałki w górę/w dół)',
  'palette.title': 'Paleta poleceń',
  'palette.placeholder': 'Szukaj kart, pól lub uruchom polecenie...',
  'palette.hint': '↑↓ nawigacja · Enter uruchom · Esc zamknij',
  'palette.empty': 'Brak pasującej karty, pola lub akcji',
  'palette.jumpTo': 'Przejdź do {{field}}',
  'palette.kind.card': 'Karta',
  'palette.kind.field': 'Pole',
  'palette.kind.action': 'Akcja',
  'toast.cardsRestored': 'Przywrócono {{count}} kart',
  'history.title': 'Historia wersji',
  'history.empty': 'Brak wcześniejszych wersji.',
  'history.compare': 'Porównaj z bieżącą',
  'history.restore': 'Przywróć',
  'history.restored': 'Przywrócono wersję',
  'history.comparePrefix': 'Zmiany od ',
  'health.title': 'Stan karty',
  'health.ok': 'Nie znaleziono problemów.',
  'health.noName': 'Karta nie ma nazwy.',
  'health.longName': 'Nazwa ma {{length}} znaków — niektóre interfejsy skracają ją po 50.',
  'health.noDescription': 'Karta nie ma opisu.',
  'health.noFirstMes': 'Karta nie ma ani pierwszej wiadomości, ani alternatywnego powitania.',
  'health.noTags': 'Brak tagów, więc karty nie da się znaleźć przez filtry tagów.',
  'health.unknownMacros': 'Nieznane makra zostaną wysłane do modelu bez zmian: {{names}}.',
  'health.unbalancedMacros': 'Niezbalansowane nawiasy makr: {{open}} otwierających wobec {{close}} zamykających.',
  'health.greetingBudget': 'Wszystkie powitania razem to {{tokens}} tokenów — powyżej limitu wyjścia {{max}}.',
  'health.noSpec': 'Nie ustawiono wersji spec — karta zostanie wyeksportowana jako v2.',
  'health.noImage': 'Brak obrazu awatara.',
  'health.loreNoKey': '{{count}} wpisów lorebooka nie ma klucza i nie jest stałych, więc nigdy się nie uruchomią.',
  'health.loreNoContent': '{{count}} wpisów lorebooka nie ma treści.',
  'health.loreDuplicateKeys': 'Zduplikowane klucze lorebooka: {{keys}}.',
  'health.loreActive': '{{count}} wpisów lorebooka uruchamia się już przy tej karcie; pozostałe potrzebują tekstu czatu.',
  'palette.results': 'Wyniki',
  'toast.langOffline': 'Ten pakiet językowy nie jest jeszcze dostępny offline — pokazujemy angielski. Zostanie wczytany przy następnym połączeniu.',
};
