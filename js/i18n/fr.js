...
export default {
  ...
  'left.search': 'Rechercher dans tous les champs et le lorebook…',
  ...
  'toast.langOffline': 'Ce pack de langue n\u2019est pas encore disponible hors ligne \u2014 l\u2019anglais est affich\u00e9. Il se chargera \u00e0 votre prochaine connexion.',
  ...
  'ai.apply': 'Appliquer',
  'ai.applyTitle': 'Appliquer ces modifications à la carte',
  'ai.errorPrefix': 'Erreur : ',
  'ai.translatePrompt': 'Traduire vers quelle langue ?',
  'ai.translateDefaultLang': 'français',
  'ai.tonePrompt': 'Quel ton ? (p. ex. formel, d\u00e9contract\u00e9, sombre, humoristique, po\u00e9tique)',
  'ai.toneDefault': 'formel',
  'ai.chatSession': 'Session de discussion',
  'ai.msgs': '{{count}} msg',
  'ai.tokensIn': ' entr\u00e9e \u00b7 ',
  'ai.tokensOut': ' sortie \u00b7 ',
  'ai.tokensCtx': ' ctx',
  'ai.exceedsLimit': ' \u26a0 Limite d\u00e9pass\u00e9e !',
  'ai.approachingLimit': ' \u26a0 Limite bient\u00f4t atteinte',
  'ai.count': 'Nombre :',
  'ai.resizeAria': 'Redimensionner l\'assistant IA',
  'ai.chatMessagesAria': 'Messages du chat IA',
  'ai.mesExamplePlaceholder': '<START>\n{{char}}: Exemple de dialogue ici...\n{{user}}: Réponse de l\'utilisateur...\n<START>\n{{char}}: Autre exemple...',
  'batch.select2ForCompare': 'S\u00e9lectionnez exactement 2 cartes \u00e0 comparer',
  'batch.compareLoadFailed': 'Impossible de charger les cartes \u00e0 comparer',
  'batch.comparePrefix': 'Comparer : ',
  'batch.compareVs': ' vs ',
  'batch.cardA': 'Carte A',
  'batch.cardB': 'Carte B',
  'editor.charCount': '{{chars}} car. ~{{tokens}} tokens',
  ...
  'editor.extensionsHint': 'Objet `extensions` brut de la carte — JSON. Le modifier peut casser des fonctions de SillyTavern.',
  'editor.extensionsParseError': 'JSON invalide — les dernières extensions valides sont conservées.',
  'editor.cardTokenTotal': '~{{tokens}} tokens · {{chars}} caractères',
  ...
  'editor.greetingMoveUp': 'Monter',
  'editor.greetingMoveDown': 'Descendre',
  'editor.greetingIsDefault': 'Ceci est le premier message actuel',
  'editor.greetingSetDefault': 'Définir comme premier message',
  'editor.greetingRemove': 'Supprimer',
  'editor.greetingPlaceholder': 'Salutation {{num}}...',
  'editor.loreEntry': 'Entrée {{num}}',
  'editor.loreDeleteEntry': 'Supprimer l\'entrée',
  'editor.lorePrimaryKeys': 'Mots-clés principaux',
  'editor.lorePrimaryKeysPlaceholder': 'Mots-clés principaux — séparés par des virgules',
  'editor.loreSecondaryKeys': 'Mots-clés secondaires',
  'editor.loreSecondaryKeysPlaceholder': 'Mots-clés secondaires',
  'editor.loreComment': 'Commentaire',
  'editor.loreCommentPlaceholder': 'Commentaire',
  'editor.loreOrder': 'Ordre',
  'editor.loreOrderPlaceholder': 'Ordre',
  'editor.loreConstant': 'Constant',
  'editor.loreSelective': 'Sélectif',
  'editor.loreBeforeChar': 'Avant le perso',
  'editor.loreAfterChar': 'Après le perso',
  'editor.loreContent': 'Contenu',
  'editor.loreContentPlaceholder': 'Contenu de l\'entrée...',
  'editor.loreNewEntry': 'Nouvelle entrée',
  'error.unknown': 'Erreur inconnue',
  'error.unexpected': 'Erreur inattendue : {{message}}',
  'error.requestFailed': 'Échec de la requête : {{message}}',
  'error.unsupportedFile': 'Type de fichier non pris en charge : .{{ext}}',
  'error.invalidJson': 'JSON invalide : {{message}}',
  'error.notPng': 'Fichier PNG invalide',
  'error.unknownFormat': 'Format de carte inconnu — ce n\'est pas une carte de personnage SillyTavern',
  'error.fetchModelsFailed': 'Échec de la récupération des modèles (HTTP {{status}})',
  'error.noChoices': 'L\'API n\'a renvoyé aucune réponse',
  'error.emptyResponse': 'Réponse vide de l\'API (aucun contenu)',
    'error.customServerError': 'Le serveur a renvoyé une erreur : {{detail}}',
  'gen.newCharacter': 'Nouveau personnage',
  'gen.bytes': ' B',
  'gen.kilobytes': ' KB',
  'gen.megabytes': ' MB',
  'settings.backup': 'Sauvegarde',
  'settings.restore': 'Restaurer',
  'settings.backupTitle': 'Sauvegarder toutes les cartes',
  'settings.restoreTitle': 'Restaurer une sauvegarde',
  'settings.exportTitle': 'Exporter les paramètres',
  'settings.importTitle': 'Importer les paramètres',
  'settings.modelAuto': 'Automatique',
  ...
  'settings.getApiKeyFrom': 'Obtenir la clé API depuis ',
  'settings.customModelDesc': 'Modèle personnalisé',
  'settings.workspaceExported': 'Espace de travail exporté ({{count}} cartes)',
  'settings.invalidWorkspace': 'Format d\'espace de travail invalide',
  'settings.workspaceImported': 'Espace de travail importé ({{count}} cartes)',
  'settings.workspaceImportFailed': 'Échec de l\'import de l\'espace de travail : {{error}}',
  'nav.brand': 'ST Card Editor',
  'nav.toggleAI': 'Afficher/masquer l\'assistant IA',
  'nav.toggleAIAria': 'Afficher/masquer l\'assistant IA',
  'nav.notificationsAria': 'Notifications',
  'left.sortCards': 'Trier les cartes',
  'left.compareSelected': 'Comparer les cartes sélectionnées',
  'left.resizeAria': 'Redimensionner la bibliothèque de cartes',
  'left.cardListAria': 'Bibliothèque de cartes',
  'ui.saved': ' Enregistré',
  'ui.collapsePanel': 'Réduire le panneau',
  'ui.expandPanel': 'Agrandir le panneau',
  'ui.cardModified': 'Modifications non enregistrées',
  'export.minimalPngLabel': 'Carte ST',
  'wizard.search': 'Rechercher',
  'wizard.quick': 'Rapide :',
  'wizard.imageSearchPlaceholder': 'Rechercher des tags : chat, robe, uniforme, cyberpunk...',
  ...
  'wizard.language.de': 'Allemand',
  'wizard.language.ja': 'Japonais',
  'wizard.language.it': 'Italien',
  'wizard.language.pl': 'Polonais',
  'wizard.language.tr': 'Turc',
  'wizard.language.nl': 'Néerlandais',
  'wizard.language.uk': 'Ukrainien',
  'wizard.language.vi': 'Vietnamien',
  'wizard.language.id': 'Indonésien',
  'wizard.language.hi': 'Hindi',
  'wizard.language.ar': 'Arabe',
  'wizard.language.he': 'Hébreu',
  'wizard.language.fa': 'Persan',
  'wizard.language.ro': 'Roumain',
  'wizard.language.cs': 'Tchèque',
  'wizard.language.sv': 'Suédois',
  'wizard.language.th': 'Thaï',
  'wizard.language.pt-pt': 'Portugais (Portugal)',
  'wizard.language.tl': 'Filipino',
  'search.results': '{{count}} carte(s) correspondante(s)',
  'search.capped': 'Les {{count}} premiers résultats sont affichés — affinez votre recherche',
  'shortcuts.palette': 'Palette de commandes',
  'library.reorderHandle': 'Réordonner la carte (flèches haut/bas)',
  'palette.title': 'Palette de commandes',
  'palette.placeholder': 'Rechercher une carte, un champ, ou lancer une commande…',
  'palette.hint': '↑↓ naviguer · Entrée pour lancer · Échap pour fermer',
  'palette.empty': 'Aucune carte, aucun champ ni aucune action correspondant',
  'palette.results': 'Résultats',
  'palette.jumpTo': 'Aller à {{field}}',
  'palette.kind.card': 'Carte',
  'palette.kind.field': 'Champ',
  'palette.kind.action': 'Action',
  'toast.cardsRestored': '{{count}} carte(s) restaurée(s)',
  'history.title': 'Historique des versions',
  'history.empty': 'Aucune version antérieure pour le moment.',
  'history.compare': 'Comparer à la version actuelle',
  'history.restore': 'Restaurer',
  'history.restored': 'Version restaurée',
  'history.comparePrefix': 'Modifications depuis le ',
  'health.title': 'Santé de la carte',
  'health.ok': 'Aucun problème détecté.',
  'health.noName': 'La carte n’a pas de nom.',
  'health.longName': 'Le nom fait {{length}} caractères — certaines interfaces tronquent au-delà de 50.',
  'health.noDescription': 'La carte n’a pas de description.',
  'health.noFirstMes': 'La carte n’a ni premier message ni salutation alternative.',
  'health.noTags': 'Aucun tag : la carte est introuvable via les filtres de tags.',
  'health.unknownMacros': 'Macro(s) inconnue(s), envoyée(s) telles quelles au modèle : {{names}}.',
  'health.unbalancedMacros': 'Accolades de macro déséquilibrées : {{open}} ouvrante(s) pour {{close}} fermante(s).',
  'health.greetingBudget': 'Toutes les salutations cumulent {{tokens}} tokens, au-delà de la limite de sortie de {{max}}.',
  'health.noSpec': 'Aucune version de spec — la carte sera exportée en v2.',
  'health.noImage': 'Aucune image d’avatar.',
  'health.loreNoKey': '{{count}} entrée(s) de lorebook sans clé et non « constant » : elles ne se déclencheront jamais.',
  'health.loreNoContent': '{{count}} entrée(s) de lorebook sans contenu.',
  'health.loreDuplicateKeys': 'Clés de lorebook en double : {{keys}}.',
  'health.loreActive': '{{count}} entrée(s) de lorebook se déclenchent sur la carte seule ; les autres attendent le texte du chat.',
};
