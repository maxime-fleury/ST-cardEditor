...
export default {
  ...
  'settings.promptVariables': 'Variabili prompt disponibili',
  'settings.varCard': 'Inserisce la scheda corrente come JSON nel prompt.',
  'settings.varLang': 'Lingua di destinazione per l\'azione rapida Traduci.',
  'settings.varTone': 'Tono scelto applicato dall\'azione rapida Tono.',
  'settings.varCount': 'Numero di elementi da generare (es. saluti alternativi).',
  'settings.varCurrent': 'Contenuto attuale del campo in modifica.',
  'settings.varField': 'Nome del campo in modifica.',
  'settings.varChar': 'Nome del personaggio, sostituito dal motore della chat (SillyTavern).',
  'settings.varUser': 'Nome utente, sostituito dal motore della chat (SillyTavern).',
  'ai.thinkingLive': 'Pensando… {{secs}}',
  'ai.streamLive': '{{tokens}} token · {{secs}}',
  'dialog.ok': 'Ok',
  'editor.extensions': 'Estensioni (JSON)',
  'editor.extensionsHint': 'Oggetto `extensions` grezzo della scheda — JSON. Modificarlo può rompere le funzioni di SillyTavern.',
  'editor.extensionsParseError': 'JSON non valido — mantengo le ultime estensioni valide.',
  'editor.cardTokenTotal': '~{{tokens}} token · {{chars}} caratteri',
  ...
  'wizard.language.de': 'Tedesco',
  'wizard.language.ja': 'Giapponese',
  'wizard.language.it': 'Italiano',
  'wizard.language.pl': 'Polacco',
  'wizard.language.tr': 'Turco',
  'wizard.language.nl': 'Olandese',
  'wizard.language.uk': 'Ucraino',
  'wizard.language.vi': 'Vietnamita',
  'wizard.language.id': 'Indonesiano',
  'wizard.language.hi': 'Hindi',
  'wizard.language.ar': 'Arabo',
  'wizard.language.he': 'Ebraico',
  'wizard.language.fa': 'Persiano',
  'wizard.language.ro': 'Rumeno',
  'wizard.language.cs': 'Ceco',
  'wizard.language.sv': 'Svedese',
  'wizard.language.th': 'Thai',
  'wizard.language.pt-pt': 'Portoghese (Portogallo)',
  'wizard.language.tl': 'Filippino',
  'search.results': '{{count}} schede corrispondenti',
  'search.capped': 'Prime {{count}} corrispondenze mostrate — affina la ricerca',
  'shortcuts.palette': 'Palette dei comandi',
  'library.reorderHandle': 'Riordina la scheda (frecce su/giù)',
  'palette.title': 'Palette dei comandi',
  'palette.placeholder': 'Cerca schede, campi o esegui un comando...',
  'palette.hint': '↑↓ naviga · Enter esegui · Esc chiudi',
  'palette.empty': 'Nessuna scheda, campo o azione corrispondente',
  'palette.jumpTo': 'Vai a {{field}}',
  'palette.kind.card': 'Scheda',
  'palette.kind.field': 'Campo',
  'palette.kind.action': 'Azione',
  'toast.cardsRestored': '{{count}} schede ripristinate',
  'history.title': 'Cronologia versioni',
  'history.empty': 'Nessuna versione precedente.',
  'history.compare': 'Confronta con l\'attuale',
  'history.restore': 'Ripristina',
  'history.restored': 'Versione ripristinata',
  'history.comparePrefix': 'Modifiche da ',
  'health.title': 'Salute della scheda',
  'health.ok': 'Nessun problema trovato.',
  'health.noName': 'La scheda non ha un nome.',
  'health.longName': 'Il nome è lungo {{length}} caratteri — alcune interfacce troncano oltre 50.',
  'health.noDescription': 'La scheda non ha una descrizione.',
  'health.noFirstMes': 'La scheda non ha né un primo messaggio né un saluto alternativo.',
  'health.noTags': 'Nessun tag, quindi la scheda non si trova tramite i filtri per tag.',
  'health.unknownMacros': 'Le macro sconosciute verranno inviate al modello così come sono: {{names}}.',
  'health.unbalancedMacros': 'Graffe delle macro non bilanciate: {{open}} di apertura contro {{close}} di chiusura.',
  'health.greetingBudget': 'Tutti i saluti sommano {{tokens}} token, oltre il limite di output di {{max}}.',
  'health.noSpec': 'Versione spec non impostata — la scheda viene esportata come v2.',
  'health.noImage': 'Nessuna immagine avatar.',
  'health.loreNoKey': '{{count}} voci del lorebook non hanno chiave e non sono costanti, quindi non si attiveranno mai.',
  'health.loreNoContent': '{{count}} voci del lorebook non hanno contenuto.',
  'health.loreDuplicateKeys': 'Chiavi del lorebook duplicate: {{keys}}.',
  'health.loreActive': '{{count}} voci del lorebook si attivano con questa sola scheda; le altre richiedono il testo della chat.',
  'palette.results': 'Risultati',
  'toast.langOffline': 'Quel pacchetto linguistico non è ancora disponibile offline — mostriamo l\'inglese. Verrà caricato la prossima volta che sarai online.',
};
