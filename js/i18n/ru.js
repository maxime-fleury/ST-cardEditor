...
export default {
  ...
  'wizard.chip.action': 'В разгаре событий',
  ...
  'ai.apply': 'Применить',
  'ai.applyTitle': 'Применить эти изменения к карточке',
  'ai.errorPrefix': 'Ошибка: ',
  'ai.translatePrompt': 'На какой язык перевести?',
  'ai.translateDefaultLang': 'Русский',
  'ai.tonePrompt': 'Какой тон? (например, формальный, разговорный, мрачный, шутливый, поэтичный)',
  'ai.toneDefault': 'формальный',
  'ai.chatSession': 'Сессия чата',
  'ai.msgs': '{{count}} сообщ.',
  'ai.tokensIn': ' вход · ',
  'ai.tokensOut': ' выход · ',
  'ai.tokensCtx': ' контекст',
  'ai.exceedsLimit': ' ⚠ Лимит превышен!',
  'ai.approachingLimit': ' ⚠ Приближение к лимиту',
  'ai.count': 'Количество:',
  'ai.resizeAria': 'Изменить размер помощника ИИ',
  'ai.chatMessagesAria': 'Сообщения чата с ИИ',
  'ai.mesExamplePlaceholder': '<START>\n{{char}}: Здесь пример диалога...\n{{user}}: Ответ пользователя...\n<START>\n{{char}}: Ещё один пример...',
  'batch.select2ForCompare': 'Выберите ровно 2 карточки для сравнения',
  'batch.compareLoadFailed': 'Не удалось загрузить карточки для сравнения',
  'batch.comparePrefix': 'Сравнение: ',
  'batch.compareVs': ' против ',
  'batch.cardA': 'Карточка A',
  'batch.cardB': 'Карточка B',
  'editor.charCount': '{{chars}} симв. ~{{tokens}} токенов',
  ...
  'settings.promptVariables': 'Доступные переменные промпта',
  'settings.varCard': 'Вставляет текущую карточку в промпт в виде JSON.',
  'settings.varLang': 'Целевой язык для быстрого действия «Перевести».',
  'settings.varTone': 'Тон, выбранный быстрым действием «Тон».',
  'settings.varCount': 'Сколько элементов создать (например, альтернативные приветствия).',
  'settings.varCurrent': 'Текущее содержимое редактируемого поля.',
  'settings.varField': 'Имя редактируемого поля.',
  'settings.varChar': 'Имя персонажа, подставляется движком чата (SillyTavern).',
  'settings.varUser': 'Имя пользователя, подставляется движком чата (SillyTavern).',
  'ai.thinkingLive': 'Думаю… {{secs}}',
  'ai.streamLive': '{{tokens}} токенов · {{secs}}',
  'dialog.ok': 'ОК',
  'editor.extensions': 'Расширения (JSON)',
  'editor.extensionsHint': 'Исходный объект `extensions` карточки — JSON. Его изменение может нарушить работу функций SillyTavern.',
  'editor.extensionsParseError': 'Некорректный JSON — сохраняем последние действительные расширения.',
  'editor.cardTokenTotal': '~{{tokens}} токенов · {{chars}} симв.',
  ...
  'editor.greetingMoveUp': 'Переместить вверх',
  'editor.greetingMoveDown': 'Переместить вниз',
  'editor.greetingIsDefault': 'Это текущее первое сообщение',
  'editor.greetingSetDefault': 'Сделать первым сообщением',
  'editor.greetingRemove': 'Удалить',
  'editor.greetingPlaceholder': 'Приветствие {{num}}...',
  'editor.loreEntry': 'Запись {{num}}',
  'editor.loreDeleteEntry': 'Удалить запись',
  'editor.lorePrimaryKeys': 'Основные ключи',
  'editor.lorePrimaryKeysPlaceholder': 'Основные ключи — через запятую',
  'editor.loreSecondaryKeys': 'Дополнительные ключи',
  'editor.loreSecondaryKeysPlaceholder': 'Дополнительные ключи',
  'editor.loreComment': 'Комментарий',
  'editor.loreCommentPlaceholder': 'Комментарий',
  'editor.loreOrder': 'Порядок',
  'editor.loreOrderPlaceholder': 'Порядок',
  'editor.loreConstant': 'Постоянная',
  'editor.loreSelective': 'Избирательная',
  'editor.loreBeforeChar': 'Перед персонажем',
  'editor.loreAfterChar': 'После персонажа',
  'editor.loreContent': 'Содержание',
  'editor.loreContentPlaceholder': 'Содержание записи...',
  'editor.loreNewEntry': 'Новая запись',
  'error.unknown': 'Неизвестная ошибка',
  'error.unexpected': 'Неожиданная ошибка: {{message}}',
  'error.requestFailed': 'Запрос не выполнен: {{message}}',
  'error.unsupportedFile': 'Неподдерживаемый тип файла: .{{ext}}',
  'error.invalidJson': 'Некорректный JSON: {{message}}',
  'error.notPng': 'Это не корректный PNG-файл',
  'error.unknownFormat': 'Неизвестный формат карточки — это не карточка персонажа SillyTavern',
  'error.fetchModelsFailed': 'Не удалось получить модели (HTTP {{status}})',
  'error.noChoices': 'API не вернул вариантов ответа',
  'error.emptyResponse': 'Пустой ответ от API (нет тела)',
  'gen.newCharacter': 'Новый персонаж',
  'gen.bytes': ' B',
  'gen.kilobytes': ' KB',
  'gen.megabytes': ' MB',
  'settings.backup': 'Резервная копия',
  'settings.restore': 'Восстановить',
  'settings.backupTitle': 'Создать резервную копию всех карточек',
  'settings.restoreTitle': 'Восстановить из копии',
  'settings.exportTitle': 'Экспорт настроек',
  'settings.importTitle': 'Импорт настроек',
  ...
  'settings.getApiKeyFrom': 'Получить ключ API: ',
  'settings.customModelDesc': 'Своя модель',
  'settings.workspaceExported': 'Рабочая область экспортирована (карточек: {{count}})',
  'settings.invalidWorkspace': 'Неверный формат рабочей области',
  'settings.workspaceImported': 'Рабочая область импортирована (карточек: {{count}})',
  'settings.workspaceImportFailed': 'Не удалось импортировать рабочую область: {{error}}',
  'nav.brand': 'ST Card Editor',
  'nav.toggleAI': 'Показать помощника ИИ',
  'nav.toggleAIAria': 'Показать помощника ИИ',
  'nav.notificationsAria': 'Уведомления',
  'left.sortCards': 'Сортировка карточек',
  'left.compareSelected': 'Сравнить выбранные карточки',
  'left.resizeAria': 'Изменить размер библиотеки карточек',
  'left.cardListAria': 'Библиотека карточек',
  'ui.saved': ' Сохранено',
  'ui.collapsePanel': 'Свернуть панель',
  'ui.expandPanel': 'Развернуть панель',
  'ui.cardModified': 'Несохранённые изменения',
  'export.minimalPngLabel': 'Карточка ST',
  'wizard.search': 'Поиск',
  'wizard.quick': 'Быстро:',
  'wizard.imageSearchPlaceholder': 'Поиск по тегам: cat, dress, uniform, cyberpunk...',
  ...
  'wizard.language.fr': 'французский',
  'wizard.language.de': 'немецкий',
  'wizard.language.ja': 'японский',
  'wizard.language.it': 'итальянский',
  'wizard.language.pl': 'польский',
  'wizard.language.tr': 'турецкий',
  'wizard.language.nl': 'нидерландский',
  'wizard.language.uk': 'украинский',
  'wizard.language.vi': 'вьетнамский',
  'wizard.language.id': 'индонезийский',
  'wizard.language.hi': 'хинди',
  'wizard.language.ar': 'арабский',
  'wizard.language.he': 'иврит',
  'wizard.language.fa': 'персидский',
  'wizard.language.ro': 'румынский',
  'wizard.language.cs': 'чешский',
  'wizard.language.sv': 'шведский',
  'wizard.language.th': 'тайский',
  'wizard.language.pt-pt': 'португальский (Португалия)',
  'wizard.language.tl': 'филиппинский',
  'search.results': 'Подходящих карточек: {{count}}',
  'search.capped': 'Показаны первые {{count}} совпадений — уточните запрос',
  'shortcuts.palette': 'Палитра команд',
  'library.reorderHandle': 'Изменить порядок карточки (стрелки вверх/вниз)',
  'palette.title': 'Палитра команд',
  'palette.placeholder': 'Искать карточки, поля или выполнить команду...',
  'palette.hint': '↑↓ навигация · Enter выполнить · Esc закрыть',
  'palette.empty': 'Нет подходящей карточки, поля или действия',
  'palette.jumpTo': 'Перейти к {{field}}',
  'palette.kind.card': 'Карточка',
  'palette.kind.field': 'Поле',
  'palette.kind.action': 'Действие',
  'toast.cardsRestored': 'Восстановлено карточек: {{count}}',
  'history.title': 'История версий',
  'history.empty': 'Пока нет более ранних версий.',
  'history.compare': 'Сравнить с текущей',
  'history.restore': 'Восстановить',
  'history.restored': 'Версия восстановлена',
  'history.comparePrefix': 'Изменения с ',
  'health.title': 'Состояние карточки',
  'health.ok': 'Проблем не найдено.',
  'health.noName': 'У карточки нет имени.',
  'health.longName': 'Имя длиной {{length}} символов — некоторые интерфейсы обрезают его после 50.',
  'health.noDescription': 'У карточки нет описания.',
  'health.noFirstMes': 'У карточки нет ни первого сообщения, ни альтернативного приветствия.',
  'health.noTags': 'Нет тегов, поэтому карточку не найти через фильтры по тегам.',
  'health.unknownMacros': 'Неизвестные макросы будут отправлены модели как есть: {{names}}.',
  'health.unbalancedMacros': 'Несбалансированные фигурные скобки макросов: {{open}} открывающих против {{close}} закрывающих.',
  'health.greetingBudget': 'Все приветствия вместе дают {{tokens}} токенов — это больше лимита вывода {{max}}.',
  'health.noSpec': 'Версия spec не задана — карточка экспортируется как v2.',
  'health.noImage': 'Нет изображения аватара.',
  'health.loreNoKey': '{{count}} записей лорбука без ключа и не постоянных — они никогда не сработают.',
  'health.loreNoContent': '{{count}} записей лорбука без содержимого.',
  'health.loreDuplicateKeys': 'Дублирующиеся ключи лорбука: {{keys}}.',
  'health.loreActive': '{{count}} записей лорбука срабатывают от одной этой карточки; остальным нужен текст чата.',
  'palette.results': 'Результаты',
  'toast.langOffline': 'Этот языковой пакет пока недоступен офлайн — показываем английский. Он загрузится при следующем подключении к сети.',
};
