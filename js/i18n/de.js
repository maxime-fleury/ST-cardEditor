...
export default {
  ...
  'ai.apply': 'Übernehmen',
  'ai.applyTitle': 'Diese Änderungen auf die Karte anwenden',
  'ai.errorPrefix': 'Fehler: ',
  'ai.translatePrompt': 'In welche Sprache übersetzen?',
  'ai.translateDefaultLang': 'Deutsch',
  'ai.tonePrompt': 'Welcher Ton? (z. B. formell, locker, düster, humorvoll, poetisch)',
  'ai.toneDefault': 'formell',
  'ai.chatSession': 'Chat-Sitzung',
  'ai.msgs': '{{count}} Nachr.',
  'ai.tokensIn': ' ein · ',
  'ai.tokensOut': ' aus · ',
  'ai.tokensCtx': ' Kontext',
  'ai.exceedsLimit': ' ⚠ Limit überschritten!',
  'ai.approachingLimit': ' ⚠ Limit fast erreicht',
  'ai.count': 'Anzahl:',
  'ai.resizeAria': 'KI-Assistent skalieren',
  'ai.chatMessagesAria': 'KI-Chat-Nachrichten',
  'ai.mesExamplePlaceholder': '<START>\n{{char}}: Beispielhafter Dialog hier...\n{{user}}: Antwort des Nutzers...\n<START>\n{{char}}: Ein weiteres Beispiel...',
  'batch.select2ForCompare': 'Genau 2 Karten zum Vergleichen auswählen',
  'batch.compareLoadFailed': 'Karten konnten nicht zum Vergleich geladen werden',
  'batch.comparePrefix': 'Vergleich: ',
  'batch.compareVs': ' vs ',
  'batch.cardA': 'Karte A',
  'batch.cardB': 'Karte B',
  'editor.charCount': '{{chars}} Zeichen ~{{tokens}} Token',
  'editor.counterWarn': 'Nahe am Token-Ausgabelimit ({{tokens}}/{{max}}).',
  'editor.counterDanger': 'Über dem Token-Ausgabelimit ({{tokens}}/{{max}}).',
  'settings.promptVariables': 'Verfügbare Prompt-Variablen',
  'settings.varCard': 'Fügt die aktuelle Karte als JSON in den Prompt ein.',
  'settings.varLang': 'Zielsprache für die Schnellaktion „Übersetzen“.',
  'settings.varTone': 'Gewählter Ton für die Schnellaktion „Ton“.',
  'settings.varCount': 'Anzahl der zu erzeugenden Elemente (z. B. alternative Begrüßungen).',
  'settings.varCurrent': 'Aktueller Inhalt des bearbeiteten Felds.',
  'settings.varField': 'Name des bearbeiteten Felds.',
  'settings.varChar': 'Charaktername, ersetzt durch die Chat-Engine (SillyTavern).',
  'settings.varUser': 'Nutzername, ersetzt durch die Chat-Engine (SillyTavern).',
  'ai.thinkingLive': 'Denke… {{secs}}',
  'ai.streamLive': '{{tokens}} Tokens · {{secs}}',
  'dialog.ok': 'OK',
  'editor.extensions': 'Erweiterungen (JSON)',
  'editor.extensionsHint': 'Rohes `extensions`-Objekt der Karte — JSON. Änderungen können SillyTavern-Funktionen beschädigen.',
  'editor.extensionsParseError': 'Ungültiges JSON — die letzten gültigen Erweiterungen bleiben erhalten.',
  'editor.cardTokenTotal': '~{{tokens}} Token · {{chars}} Zeichen',
  ...
  'editor.greetingMoveUp': 'Nach oben',
  'editor.greetingMoveDown': 'Nach unten',
  'editor.greetingIsDefault': 'Dies ist die aktuelle erste Nachricht',
  'editor.greetingSetDefault': 'Als erste Nachricht festlegen',
  'editor.greetingRemove': 'Entfernen',
  'editor.greetingPlaceholder': 'Begrüßung {{num}}...',
  'editor.loreEntry': 'Eintrag {{num}}',
  'editor.loreDeleteEntry': 'Eintrag löschen',
  'editor.lorePrimaryKeys': 'Primäre Schlüsselwörter',
  'editor.lorePrimaryKeysPlaceholder': 'Primäre Schlüsselwörter — durch Kommas getrennt',
  'editor.loreSecondaryKeys': 'Sekundäre Schlüsselwörter',
  'editor.loreSecondaryKeysPlaceholder': 'Sekundäre Schlüsselwörter',
  'editor.loreComment': 'Kommentar',
  'editor.loreCommentPlaceholder': 'Kommentar',
  'editor.loreOrder': 'Reihenfolge',
  'editor.loreOrderPlaceholder': 'Reihenfolge',
  'editor.loreConstant': 'Konstant',
  'editor.loreSelective': 'Selektiv',
  'editor.loreBeforeChar': 'Vor Char',
  'editor.loreAfterChar': 'Nach Char',
  'editor.loreContent': 'Inhalt',
  'editor.loreContentPlaceholder': 'Eintragsinhalt...',
  'editor.loreNewEntry': 'Neuer Eintrag',
  'error.unknown': 'Unbekannter Fehler',
  'error.unexpected': 'Unerwarteter Fehler: {{message}}',
  'error.requestFailed': 'Anfrage fehlgeschlagen: {{message}}',
  'error.unsupportedFile': 'Nicht unterstützter Dateityp: .{{ext}}',
  'error.invalidJson': 'Ungültiges JSON: {{message}}',
  'error.notPng': 'Keine gültige PNG-Datei',
  'error.unknownFormat': 'Unbekanntes Kartenformat — keine SillyTavern-Charakterkarte',
  'error.fetchModelsFailed': 'Modelle konnten nicht geladen werden (HTTP {{status}})',
  'error.noChoices': 'Die API hat keine Antwortauswahl zurückgegeben',
  'error.emptyResponse': 'Leere Antwort der API (kein Inhalt)',
  'gen.newCharacter': 'Neuer Charakter',
  'gen.bytes': ' B',
  'gen.kilobytes': ' KB',
  'gen.megabytes': ' MB',
  'settings.backup': 'Sicherung',
  'settings.restore': 'Wiederherstellen',
  'settings.backupTitle': 'Alle Karten sichern',
  'settings.restoreTitle': 'Sicherung wiederherstellen',
  'settings.exportTitle': 'Einstellungen exportieren',
  'settings.importTitle': 'Einstellungen importieren',
  'settings.modelAuto': 'Automatisch',
  'settings.modelIdPlaceholder': 'z. B. deepseek-v4-flash',
  'settings.customModelPlaceholder': 'z. B. llama-3.2-8b-instruct',
  'settings.namedModelPlaceholder': 'z. B. {{provider}}-latest',
  'settings.getApiKeyFrom': 'API-Schlüssel beziehen von ',
  'settings.customModelDesc': 'Benutzerdefiniertes Modell',
  'settings.workspaceExported': 'Arbeitsbereich exportiert ({{count}} Karten)',
  'settings.invalidWorkspace': 'Ungültiges Arbeitsbereich-Format',
  'settings.workspaceImported': 'Arbeitsbereich importiert ({{count}} Karten)',
  'settings.workspaceImportFailed': 'Arbeitsbereich konnte nicht importiert werden: {{error}}',
  'nav.brand': 'ST Card Editor',
  'nav.toggleAI': 'KI-Assistent umschalten',
  'nav.toggleAIAria': 'KI-Assistent umschalten',
  'nav.notificationsAria': 'Benachrichtigungen',
  'left.sortCards': 'Karten sortieren',
  'left.compareSelected': 'Ausgewählte Karten vergleichen',
  'left.resizeAria': 'Kartenbibliothek skalieren',
  'left.cardListAria': 'Kartenbibliothek',
  ...
  'export.minimalPngLabel': 'ST-Karte',
  'wizard.search': 'Suchen',
  'wizard.quick': 'Schnell:',
  'wizard.imageSearchPlaceholder': 'Tags suchen: Katze, Kleid, Uniform, Cyberpunk...',
  ...
  'wizard.language.en': 'Englisch',
  'wizard.language.fr': 'Französisch',
  'wizard.language.de': 'Deutsch',
  'wizard.language.ja': 'Japanisch',
  'wizard.language.it': 'Italienisch',
  'wizard.language.pl': 'Polnisch',
  'wizard.language.tr': 'Türkisch',
  'wizard.language.nl': 'Niederländisch',
  'wizard.language.uk': 'Ukrainisch',
  'wizard.language.vi': 'Vietnamesisch',
  'wizard.language.id': 'Indonesisch',
  'wizard.language.hi': 'Hindi',
  'wizard.language.ar': 'Arabisch',
  'wizard.language.he': 'Hebräisch',
  'wizard.language.fa': 'Persisch',
  'wizard.language.ro': 'Rumänisch',
  'wizard.language.cs': 'Tschechisch',
  'wizard.language.sv': 'Schwedisch',
  'wizard.language.th': 'Thailändisch',
  'wizard.language.pt-pt': 'Portugiesisch (Portugal)',
  'wizard.language.tl': 'Filipino',
  'search.results': '{{count}} passende Karte(n)',
  'search.capped': 'Es werden nur die ersten {{count}} Treffer angezeigt — grenze die Suche ein',
  'shortcuts.palette': 'Befehlspalette',
  'library.reorderHandle': 'Karte verschieben (Pfeiltasten Auf/Ab)',
  'palette.title': 'Befehlspalette',
  'palette.placeholder': 'Karten und Felder durchsuchen oder Befehl ausführen...',
  'palette.hint': '↑↓ navigieren · Enter ausführen · Esc schließen',
  'palette.empty': 'Keine passende Karte, kein Feld, kein Befehl',
  'palette.jumpTo': 'Zu {{field}} springen',
  'palette.kind.card': 'Karte',
  'palette.kind.field': 'Feld',
  'palette.kind.action': 'Befehl',
  'toast.cardsRestored': '{{count}} Karte(n) wiederhergestellt',
  'history.title': 'Versionsverlauf',
  'history.empty': 'Noch keine früheren Versionen.',
  'history.compare': 'Mit aktueller Version vergleichen',
  'history.restore': 'Wiederherstellen',
  'history.restored': 'Version wiederhergestellt',
  'history.comparePrefix': 'Änderungen seit ',
  'health.title': 'Karten-Gesundheit',
  'health.ok': 'Keine Probleme gefunden.',
  'health.noName': 'Die Karte hat keinen Namen.',
  'health.longName': 'Der Name ist {{length}} Zeichen lang — manche Oberflächen schneiden nach 50 ab.',
  'health.noDescription': 'Die Karte hat keine Beschreibung.',
  'health.noFirstMes': 'Die Karte hat weder eine erste Nachricht noch eine alternative Begrüßung.',
  'health.noTags': 'Keine Tags — die Karte ist über die Tag-Filter nicht auffindbar.',
  'health.unknownMacros': 'Unbekannte Makros werden unverändert an das Modell gesendet: {{names}}.',
  'health.unbalancedMacros': 'Unausgeglichene Makro-Klammern: {{open}} öffnend vs. {{close}} schließend.',
  'health.greetingBudget': 'Alle Begrüßungen ergeben zusammen {{tokens}} Token und überschreiten das Ausgabelimit von {{max}}.',
  'health.noSpec': 'Keine Spec-Version gesetzt — die Karte wird als v2 exportiert.',
  'health.noImage': 'Kein Avatar-Bild.',
  'health.loreNoKey': '{{count}} Lorebook-Einträge haben keinen Schlüssel und sind nicht konstant — sie können daher nie auslösen.',
  'health.loreNoContent': '{{count}} Lorebook-Einträge haben keinen Inhalt.',
  'health.loreDuplicateKeys': 'Doppelte Lorebook-Schlüssel: {{keys}}.',
  'health.loreActive': '{{count}} Lorebook-Einträge lösen allein durch diese Karte aus; die übrigen brauchen Chat-Text.',
  'palette.results': 'Ergebnisse',
  'toast.langOffline': 'Dieses Sprachpaket ist noch nicht offline verfügbar — Englisch wird angezeigt. Es wird geladen, sobald du wieder online bist.',
};
