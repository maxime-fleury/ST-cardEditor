...
export default {
  ...
  'settings.promptVariables': 'Доступні змінні промпту',
  'settings.varCard': 'Вставляє поточну картку як JSON у промпт.',
  'settings.varLang': 'Цільова мова для швидкої дії «Перекласти».',
  'settings.varTone': 'Тон, вибраний швидкою дією «Тон».',
  'settings.varCount': 'Скільки елементів створити (наприклад, альтернативні вітання).',
  'settings.varCurrent': 'Поточний вміст поля, яке редагується.',
  'settings.varField': 'Назва поля, яке редагується.',
  'settings.varChar': 'Ім\'я персонажа, підставляє рушій чату (SillyTavern).',
  'settings.varUser': 'Ім\'я користувача, підставляє рушій чату (SillyTavern).',
  'ai.thinkingLive': 'Думаю… {{secs}}',
  'ai.streamLive': '{{tokens}} токенів · {{secs}}',
  'dialog.ok': 'ОК',
  'editor.extensions': 'Розширення (JSON)',
  'editor.extensionsHint': 'Сирий об\'єкт `extensions` картки — JSON. Його редагування може зламати функції SillyTavern.',
  'editor.extensionsParseError': 'Некоректний JSON — збережено останні чинні розширення.',
  'editor.cardTokenTotal': '~{{tokens}} токенів · {{chars}} символів',
  ...
  'wizard.language.en': 'англійська',
  'wizard.language.fr': 'французька',
  'wizard.language.de': 'німецька',
  'wizard.language.ja': 'японська',
  'wizard.language.it': 'італійська',
  'wizard.language.pl': 'польська',
  'wizard.language.tr': 'турецька',
  'wizard.language.nl': 'нідерландська',
  'wizard.language.uk': 'українська',
  'wizard.language.vi': 'в\'єтнамська',
  'wizard.language.id': 'індонезійська',
  'wizard.language.hi': 'гінді',
  'wizard.language.ar': 'арабська',
  'wizard.language.he': 'іврит',
  'wizard.language.fa': 'перська',
  'wizard.language.ro': 'румунська',
  'wizard.language.cs': 'чеська',
  'wizard.language.sv': 'шведська',
  'wizard.language.th': 'тайська',
  'wizard.language.pt-pt': 'португальська (Португалія)',
  'wizard.language.tl': 'філіппінська',
  'search.results': '{{count}} відповідних карток',
  'search.capped': 'Показано перші {{count}} збігів — уточніть пошук',
  'shortcuts.palette': 'Палітра команд',
  'library.reorderHandle': 'Змінити порядок картки (стрілки вгору/вниз)',
  'palette.title': 'Палітра команд',
  'palette.placeholder': 'Шукайте картки, поля або виконайте команду...',
  'palette.hint': '↑↓ навігація · Enter виконати · Esc закрити',
  'palette.empty': 'Немає відповідної картки, поля чи дії',
  'palette.jumpTo': 'Перейти до {{field}}',
  'palette.kind.card': 'Картка',
  'palette.kind.field': 'Поле',
  'palette.kind.action': 'Дія',
  'toast.cardsRestored': 'Відновлено карток: {{count}}',
  'history.title': 'Історія версій',
  'history.empty': 'Ще немає попередніх версій.',
  'history.compare': 'Порівняти з поточною',
  'history.restore': 'Відновити',
  'history.restored': 'Версію відновлено',
  'history.comparePrefix': 'Зміни від ',
  'health.title': 'Стан картки',
  'health.ok': 'Проблем не знайдено.',
  'health.noName': 'Картка не має назви.',
  'health.longName': 'Назва завдовжки {{length}} символів — деякі інтерфейси обрізають після 50.',
  'health.noDescription': 'Картка не має опису.',
  'health.noFirstMes': 'У картки немає ні першого повідомлення, ні альтернативного вітання.',
  'health.noTags': 'Немає тегів, тож картку не знайти через фільтри тегів.',
  'health.unknownMacros': 'Невідомі макроси буде надіслано моделі як є: {{names}}.',
  'health.unbalancedMacros': 'Незбалансовані фігурні дужки макросів: {{open}} відкривних проти {{close}} закривних.',
  'health.greetingBudget': 'Усі вітання разом — {{tokens}} токенів, більше за ліміт виводу {{max}}.',
  'health.noSpec': 'Версію spec не встановлено — картку буде експортовано як v2.',
  'health.noImage': 'Немає зображення аватара.',
  'health.loreNoKey': '{{count}} записів лорбуку не мають ключа й не є постійними, тож ніколи не спрацюють.',
  'health.loreNoContent': '{{count}} записів лорбуку не мають вмісту.',
  'health.loreDuplicateKeys': 'Дублікати ключів лорбуку: {{keys}}.',
  'health.loreActive': '{{count}} записів лорбуку спрацьовують від самої цієї картки; решта потребує тексту чату.',
  'palette.results': 'Результати',
  'toast.langOffline': 'Цього мовного пакета ще немає офлайн — показуємо англійську. Його буде завантажено, коли ви наступного разу будете онлайн.',
};
