...
export default {
  ...
  'ai.apply': 'Aplicar',
  'ai.applyTitle': 'Aplicar estas alterações à carta',
  'ai.errorPrefix': 'Erro: ',
  'ai.translatePrompt': 'Traduzir para qual idioma?',
  'ai.translateDefaultLang': 'Português',
  'ai.tonePrompt': 'Qual tom? (ex.: formal, casual, sombrio, bem-humorado, poético)',
  'ai.toneDefault': 'formal',
  'ai.chatSession': 'Sessão de chat',
  'ai.msgs': '{{count}} mens.',
  'ai.tokensIn': ' ent. · ',
  'ai.tokensOut': ' saí. · ',
  'ai.tokensCtx': ' contexto',
  'ai.exceedsLimit': ' ⚠ Limite excedido!',
  'ai.approachingLimit': ' ⚠ Perto do limite',
  'ai.count': 'Contagem:',
  'ai.resizeAria': 'Redimensionar assistente de IA',
  'ai.chatMessagesAria': 'Mensagens do chat de IA',
  'ai.mesExamplePlaceholder': '<START>\n{{char}}: Exemplo de diálogo aqui...\n{{user}}: Resposta do usuário...\n<START>\n{{char}}: Outro exemplo...',
  'batch.select2ForCompare': 'Selecione exatamente 2 cartas para comparar',
  'batch.compareLoadFailed': 'Falha ao carregar cartas para comparação',
  ...
  'settings.varCard': 'Insere a carta atual como JSON no prompt.',
  'settings.varLang': 'Idioma de destino para a ação rápida Traduzir.',
  'settings.varTone': 'Tom escolhido aplicado pela ação rápida Tom.',
  'settings.varCount': 'Número de itens a gerar (ex.: saudações alternativas).',
  'settings.varCurrent': 'Conteúdo atual do campo em edição.',
  'settings.varField': 'Nome do campo em edição.',
  'settings.varChar': 'Nome do personagem, substituído pelo motor de chat (SillyTavern).',
  'settings.varUser': 'Nome do usuário, substituído pelo motor de chat (SillyTavern).',
  'ai.thinkingLive': 'Pensando… {{secs}}',
  'ai.streamLive': '{{tokens}} tokens · {{secs}}',
  'dialog.ok': 'OK',
  'editor.extensions': 'Extensões (JSON)',
  'editor.extensionsHint': 'Objeto `extensions` bruto da carta — JSON. Editar isso pode quebrar recursos do SillyTavern.',
  'editor.extensionsParseError': 'JSON inválido — mantendo as últimas extensões válidas.',
  ...
  'editor.loreDeleteEntry': 'Excluir entrada',
  ...
  'editor.loreAfterChar': 'Depois do char',
  ...
  'error.requestFailed': 'Falha na requisição: {{message}}',
  'error.unsupportedFile': 'Tipo de arquivo não suportado: .{{ext}}',
  'error.invalidJson': 'JSON inválido: {{message}}',
  'error.notPng': 'Arquivo PNG inválido',
  'error.unknownFormat': 'Formato de carta desconhecido — não é uma carta de personagem do SillyTavern',
  'error.fetchModelsFailed': 'Falha ao buscar modelos (HTTP {{status}})',
  'error.noChoices': 'A API não retornou opções de resposta',
  ...
  'settings.backupTitle': 'Fazer backup de todas as cartas',
  'settings.restoreTitle': 'Restaurar backup',
  'settings.exportTitle': 'Exportar configurações',
  'settings.importTitle': 'Importar configurações',
  ...
  'settings.getApiKeyFrom': 'Obter chave de API em ',
  'settings.customModelDesc': 'Modelo personalizado',
  'settings.workspaceExported': 'Workspace exportado ({{count}} cartas)',
  'settings.invalidWorkspace': 'Formato de workspace inválido',
  'settings.workspaceImported': 'Workspace importado ({{count}} cartas)',
  'settings.workspaceImportFailed': 'Falha ao importar o workspace: {{error}}',
  'nav.brand': 'ST Card Editor',
  'nav.toggleAI': 'Alternar assistente de IA',
  'nav.toggleAIAria': 'Alternar assistente de IA',
  'nav.notificationsAria': 'Notificações',
  'left.sortCards': 'Ordenar cartas',
  'left.compareSelected': 'Comparar cartas selecionadas',
  'left.resizeAria': 'Redimensionar biblioteca de cartas',
  'left.cardListAria': 'Biblioteca de cartas',
  'ui.saved': ' Salvo',
  'ui.collapsePanel': 'Recolher painel',
  'ui.expandPanel': 'Expandir painel',
  'ui.cardModified': 'Alterações não salvas',
  'export.minimalPngLabel': 'Carta ST',
  'wizard.search': 'Buscar',
  'wizard.quick': 'Rápido:',
  'wizard.imageSearchPlaceholder': 'Buscar tags: gato, vestido, uniforme, cyberpunk...',
  ...
  'health.title': 'Saúde da carta',
  'health.ok': 'Nenhum problema encontrado.',
  'health.noName': 'A carta não tem nome.',
  'health.longName': 'O nome tem {{length}} caracteres — algumas interfaces cortam depois de 50.',
  'health.noDescription': 'A carta não tem descrição.',
  'health.noFirstMes': 'A carta não tem primeira mensagem nem saudação alternativa.',
  'health.noTags': 'Sem tags, então a carta não aparece nos filtros de tag.',
  'health.unknownMacros': 'Macros desconhecidas serão enviadas ao modelo como estão: {{names}}.',
  'health.unbalancedMacros': 'Chaves de macro desbalanceadas: {{open}} abrindo contra {{close}} fechando.',
  'health.greetingBudget': 'Todas as saudações somam {{tokens}} tokens, acima do limite de saída de {{max}}.',
  'health.noSpec': 'Nenhuma versão de spec definida — a carta é exportada como v2.',
  'health.noImage': 'Sem imagem de avatar.',
  'health.loreNoKey': '{{count}} entradas de lorebook não têm chave e não são constantes, então nunca podem ser acionadas.',
  ...
  'health.loreActive': '{{count}} entradas de lorebook são acionadas só por esta carta; as demais precisam de texto do chat.',
  'palette.results': 'Resultados',
  'toast.langOffline': 'Este pacote de idioma ainda não está disponível offline — exibindo inglês. Ele será carregado na próxima vez que você estiver online.',
};
