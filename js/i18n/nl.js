...
export default {
  ...
  'wizard.scenarioLabel': 'Scenario / Omgeving',
  ...
  'settings.promptVariables': 'Beschikbare promptvariabelen',
  'settings.varCard': 'Voegt de huidige kaart als JSON in de prompt in.',
  'settings.varLang': 'Doeltaal voor de snelle actie Vertalen.',
  'settings.varTone': 'Gekozen toon voor de snelle actie Toon.',
  'settings.varCount': 'Aantal te genereren items (bijv. alternatieve begroetingen).',
  'settings.varCurrent': 'Huidige inhoud van het veld dat je bewerkt.',
  'settings.varField': 'Naam van het veld dat je bewerkt.',
  'settings.varChar': 'Personagenaam, vervangen door de chatengine (SillyTavern).',
  'settings.varUser': 'Gebruikersnaam, vervangen door de chatengine (SillyTavern).',
  'ai.thinkingLive': 'Denken… {{secs}}',
  'ai.streamLive': '{{tokens}} tokens · {{secs}}',
  'dialog.ok': 'Oké',
  'editor.extensions': 'Uitbreidingen (JSON)',
  'editor.extensionsHint': 'Ruw `extensions`-object van de kaart — JSON. Aanpassen kan SillyTavern-functies breken.',
  'editor.extensionsParseError': 'Ongeldige JSON — de laatste geldige uitbreidingen blijven behouden.',
  'editor.cardTokenTotal': '~{{tokens}} tokens · {{chars}} tekens',
  ...
  'wizard.language.en': 'Engels',
  'wizard.language.fr': 'Frans',
  'wizard.language.de': 'Duits',
  'wizard.language.ja': 'Japans',
  'wizard.language.it': 'Italiaans',
  'wizard.language.pl': 'Pools',
  'wizard.language.tr': 'Turks',
  'wizard.language.nl': 'Nederlands',
  'wizard.language.uk': 'Oekraïens',
  'wizard.language.vi': 'Vietnamees',
  'wizard.language.id': 'Indonesisch',
  'wizard.language.hi': 'Hindi',
  'wizard.language.ar': 'Arabisch',
  'wizard.language.he': 'Hebreeuws',
  'wizard.language.fa': 'Perzisch',
  'wizard.language.ro': 'Roemeens',
  'wizard.language.cs': 'Tsjechisch',
  'wizard.language.sv': 'Zweeds',
  'wizard.language.th': 'Thais',
  'wizard.language.pt-pt': 'Portugees (Portugal)',
  'wizard.language.tl': 'Filipijns',
  'search.results': '{{count}} overeenkomende kaarten',
  'search.capped': 'Eerste {{count}} resultaten getoond — verfijn je zoekopdracht',
  'shortcuts.palette': 'Opdrachtpalet',
  'library.reorderHandle': 'Kaart herordenen (pijltjes omhoog/omlaag)',
  'palette.title': 'Opdrachtpalet',
  'palette.placeholder': 'Zoek kaarten, velden of voer een opdracht uit...',
  'palette.hint': '↑↓ navigeren · Enter uitvoeren · Esc sluiten',
  'palette.empty': 'Geen overeenkomende kaart, veld of actie',
  'palette.jumpTo': 'Ga naar {{field}}',
  'palette.kind.card': 'Kaart',
  'palette.kind.field': 'Veld',
  'palette.kind.action': 'Actie',
  'toast.cardsRestored': '{{count}} kaarten hersteld',
  'history.title': 'Versiegeschiedenis',
  'history.empty': 'Nog geen eerdere versies.',
  'history.compare': 'Vergelijken met huidige',
  'history.restore': 'Herstellen',
  'history.restored': 'Versie hersteld',
  'history.comparePrefix': 'Wijzigingen sinds ',
  'health.title': 'Kaartgezondheid',
  'health.ok': 'Geen problemen gevonden.',
  'health.noName': 'De kaart heeft geen naam.',
  'health.longName': 'De naam is {{length}} tekens lang — sommige interfaces korten af na 50.',
  'health.noDescription': 'De kaart heeft geen beschrijving.',
  'health.noFirstMes': 'De kaart heeft geen eerste bericht en ook geen alternatieve begroeting.',
  'health.noTags': 'Geen tags, dus de kaart is niet te vinden via de tagfilters.',
  'health.unknownMacros': 'Onbekende macro\'s worden ongewijzigd naar het model gestuurd: {{names}}.',
  'health.unbalancedMacros': 'Ongebalanceerde macro-accolades: {{open}} openend tegen {{close}} sluitend.',
  'health.greetingBudget': 'Alle begroetingen samen zijn {{tokens}} tokens — meer dan de uitvoerlimiet van {{max}}.',
  'health.noSpec': 'Geen spec-versie ingesteld — de kaart wordt geëxporteerd als v2.',
  'health.noImage': 'Geen avatarafbeelding.',
  'health.loreNoKey': '{{count}} lorebook-item(s) hebben geen sleutel en zijn niet constant, dus ze gaan nooit af.',
  'health.loreNoContent': '{{count}} lorebook-item(s) hebben geen inhoud.',
  'health.loreDuplicateKeys': 'Dubbele lorebook-sleutels: {{keys}}.',
  'health.loreActive': '{{count}} lorebook-item(s) gaan al op deze kaart alleen af; de rest heeft chattekst nodig.',
  'palette.results': 'Resultaten',
  'toast.langOffline': 'Dat taalpakket is nog niet offline beschikbaar — we tonen Engels. Het wordt geladen zodra je weer online bent.',
};
