...
export default {
  ...
  'settings.promptVariables': 'उपलब्ध प्रॉम्प्ट वेरिएबल',
  'settings.varCard': 'वर्तमान कार्ड को JSON के रूप में प्रॉम्प्ट में डालता है।',
  'settings.varLang': 'अनुवाद क्विक क्रिया के लिए लक्ष्य भाषा।',
  'settings.varTone': 'टोन क्विक क्रिया द्वारा चुना गया लहजा।',
  'settings.varCount': 'बनाए जाने वाले आइटम की संख्या (जैसे वैकल्पिक अभिवादन)।',
  'settings.varCurrent': 'संपादित किए जा रहे फ़ील्ड की वर्तमान सामग्री।',
  'settings.varField': 'संपादित किए जा रहे फ़ील्ड का नाम।',
  'settings.varChar': 'पात्र का नाम, जिसे चैट इंजन (SillyTavern) बदलता है।',
  'settings.varUser': 'उपयोगकर्ता का नाम, जिसे चैट इंजन (SillyTavern) बदलता है।',
  'ai.thinkingLive': 'सोच रहा है… {{secs}}',
  'ai.streamLive': '{{tokens}} टोकन · {{secs}}',
  'dialog.ok': 'ठीक है',
  'editor.extensions': 'एक्सटेंशन (JSON)',
  'editor.extensionsHint': 'कार्ड का कच्चा `extensions` ऑब्जेक्ट — JSON। इसे बदलने से SillyTavern की सुविधाएँ टूट सकती हैं।',
  'editor.extensionsParseError': 'अमान्य JSON — पिछला मान्य एक्सटेंशन बनाए रखा जा रहा है।',
  'editor.cardTokenTotal': '~{{tokens}} टोकन · {{chars}} अक्षर',
  'dialog.cancel': 'रद्द करें',
  'dialog.delete': 'हटाएँ',
  'ai.translateTitle': 'कार्ड का अनुवाद करें',
  'ai.translateMessage': 'कार्ड का किस भाषा में अनुवाद करना है?',
  'ai.toneTitle': 'लहजा बदलें',
  'ai.toneMessage': 'विवरण किस लहजे में फिर से लिखा जाए?',
  'batch.deleteTitle': '{{count}} कार्ड हटाएँ?',
  'settings.clearTitle': 'सारा डेटा हटाएँ?',
  ...
  'wizard.language.en': 'अंग्रेज़ी',
  'wizard.language.fr': 'फ़्रेंच',
  'wizard.language.de': 'जर्मन',
  'wizard.language.ja': 'जापानी',
  'wizard.language.it': 'इतालवी',
  'wizard.language.pl': 'पोलिश',
  'wizard.language.tr': 'तुर्की',
  'wizard.language.nl': 'डच',
  'wizard.language.uk': 'यूक्रेनी',
  'wizard.language.vi': 'वियतनामी',
  'wizard.language.id': 'इंडोनेशियाई',
  'wizard.language.hi': 'हिन्दी',
  'wizard.language.ar': 'अरबी',
  'wizard.language.he': 'हिब्रू',
  'wizard.language.fa': 'फ़ारसी',
  'wizard.language.ro': 'रोमानियाई',
  'wizard.language.cs': 'चेक',
  'wizard.language.sv': 'स्वीडिश',
  'wizard.language.th': 'थाई',
  'wizard.language.pt-pt': 'पुर्तगाली (पुर्तगाल)',
  'wizard.language.tl': 'फ़िलिपीनो',
  'search.results': '{{count}} मेल खाते कार्ड',
  'search.capped': 'पहले {{count}} परिणाम दिखाए जा रहे हैं — खोज को सीमित करें',
  'shortcuts.palette': 'कमांड पैलेट',
  'library.reorderHandle': 'कार्ड का क्रम बदलें (ऊपर/नीचे तीर)',
  'palette.title': 'कमांड पैलेट',
  'palette.placeholder': 'कार्ड, फ़ील्ड खोजें या कोई कमांड चलाएँ...',
  'palette.hint': '↑↓ नेविगेट · Enter चलाएँ · Esc बंद करें',
  'palette.empty': 'कोई मेल खाता कार्ड, फ़ील्ड या क्रिया नहीं',
  'palette.jumpTo': '{{field}} पर जाएँ',
  'palette.kind.card': 'कार्ड',
  'palette.kind.field': 'फ़ील्ड',
  'palette.kind.action': 'क्रिया',
  'toast.cardsRestored': '{{count}} कार्ड पुनर्स्थापित',
  'history.title': 'संस्करण इतिहास',
  'history.empty': 'अभी कोई पुराना संस्करण नहीं है।',
  'history.compare': 'वर्तमान से तुलना करें',
  'history.restore': 'पुनर्स्थापित करें',
  'history.restored': 'संस्करण पुनर्स्थापित',
  'history.comparePrefix': 'इसके बाद के बदलाव: ',
  'health.title': 'कार्ड की स्थिति',
  'health.ok': 'कोई समस्या नहीं मिली।',
  'health.noName': 'कार्ड का कोई नाम नहीं है।',
  'health.longName': 'नाम {{length}} अक्षरों का है — कुछ इंटरफ़ेस 50 के बाद काट देते हैं।',
  'health.noDescription': 'कार्ड का कोई विवरण नहीं है।',
  'health.noFirstMes': 'कार्ड में न पहला संदेश है और न ही कोई वैकल्पिक अभिवादन।',
  'health.noTags': 'कोई टैग नहीं, इसलिए टैग फ़िल्टर से कार्ड नहीं मिल सकता।',
  'health.unknownMacros': 'अज्ञात मैक्रो मॉडल को जैसे हैं वैसे भेजे जाएँगे: {{names}}।',
  'health.unbalancedMacros': 'मैक्रो ब्रेस असंतुलित हैं: {{open}} खुलने वाले बनाम {{close}} बंद होने वाले।',
  'health.greetingBudget': 'सभी अभिवादन मिलाकर {{tokens}} टोकन हैं, जो {{max}} की आउटपुट सीमा से अधिक है।',
  'health.noSpec': 'spec संस्करण सेट नहीं है — कार्ड v2 के रूप में निर्यात होगा।',
  'health.noImage': 'कोई अवतार छवि नहीं।',
  'health.loreNoKey': '{{count}} लोरबुक प्रविष्टियों में कोई कुंजी नहीं है और वे स्थायी भी नहीं हैं, इसलिए वे कभी सक्रिय नहीं होंगी।',
  'health.loreNoContent': '{{count}} लोरबुक प्रविष्टियों में कोई सामग्री नहीं है।',
  'health.loreDuplicateKeys': 'लोरबुक कुंजियाँ दोहराई गई हैं: {{keys}}।',
  'health.loreActive': '{{count}} लोरबुक प्रविष्टियाँ केवल इसी कार्ड से सक्रिय होती हैं; बाकी को चैट टेक्स्ट चाहिए।',
  'palette.results': 'परिणाम',
  'toast.langOffline': 'वह भाषा पैक अभी ऑफ़लाइन उपलब्ध नहीं है — अंग्रेज़ी दिखाई जा रही है। अगली बार ऑनलाइन होने पर यह लोड हो जाएगा।',
};
