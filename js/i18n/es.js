...
export default {
  ...
  'ai.apply': 'Aplicar',
  'ai.applyTitle': 'Aplicar estos cambios a la carta',
  'ai.errorPrefix': 'Error: ',
  'ai.translatePrompt': '¿A qué idioma traducir?',
  'ai.translateDefaultLang': 'Español',
  'ai.tonePrompt': '¿Qué tono? (p. ej. formal, casual, oscuro, humorístico, poético)',
  'ai.toneDefault': 'formal',
  'ai.chatSession': 'Sesión de chat',
  'ai.msgs': '{{count}} msjs.',
  'ai.tokensIn': ' ent. · ',
  'ai.tokensOut': ' sal. · ',
  'ai.tokensCtx': ' contexto',
  'ai.exceedsLimit': ' ⚠ ¡Límite superado!',
  'ai.approachingLimit': ' ⚠ Cerca del límite',
  'ai.count': 'Recuento:',
  'ai.resizeAria': 'Redimensionar el asistente de IA',
  'ai.chatMessagesAria': 'Mensajes del chat de IA',
  'ai.mesExamplePlaceholder': '<START>\n{{char}}: Ejemplo de diálogo aquí...\n{{user}}: Respuesta del usuario...\n<START>\n{{char}}: Otro ejemplo...',
  'batch.select2ForCompare': 'Selecciona exactamente 2 cartas para comparar',
  'batch.compareLoadFailed': 'No se pudieron cargar las cartas para comparar',
  ...
  'settings.promptVariables': 'Variables de prompt disponibles',
  'settings.varCard': 'Inserta la carta actual como JSON en el prompt.',
  'settings.varLang': 'Idioma de destino para la acción rápida Traducir.',
  'settings.varTone': 'Tono elegido que aplica la acción rápida Tono.',
  'settings.varCount': 'Número de elementos a generar (p. ej. saludos alternativos).',
  'settings.varCurrent': 'Contenido actual del campo que editas.',
  'settings.varField': 'Nombre del campo que editas.',
  'settings.varChar': 'Nombre del personaje, sustituido por el motor de chat (SillyTavern).',
  'settings.varUser': 'Nombre del usuario, sustituido por el motor de chat (SillyTavern).',
  'ai.thinkingLive': 'Pensando… {{secs}}',
  'ai.streamLive': '{{tokens}} tokens · {{secs}}',
  'dialog.ok': 'OK',
  'editor.extensions': 'Extensiones (JSON)',
  'editor.extensionsHint': 'Objeto `extensions` sin procesar de la carta — JSON. Editarlo puede romper funciones de SillyTavern.',
  'editor.extensionsParseError': 'JSON inválido — se conservan las últimas extensiones válidas.',
  ...
  'editor.greetingMoveUp': 'Subir',
  'editor.greetingMoveDown': 'Bajar',
  'editor.greetingIsDefault': 'Este es el primer mensaje actual',
  'editor.greetingSetDefault': 'Definir como primer mensaje',
  'editor.greetingRemove': 'Quitar',
  'editor.greetingPlaceholder': 'Saludo {{num}}...',
  'editor.loreEntry': 'Entrada {{num}}',
  'editor.loreDeleteEntry': 'Eliminar entrada',
  'editor.lorePrimaryKeys': 'Palabras clave principales',
  'editor.lorePrimaryKeysPlaceholder': 'Palabras clave principales — separadas por comas',
  'editor.loreSecondaryKeys': 'Palabras clave secundarias',
  'editor.loreSecondaryKeysPlaceholder': 'Palabras clave secundarias',
  'editor.loreComment': 'Comentario',
  'editor.loreCommentPlaceholder': 'Comentario',
  'editor.loreOrder': 'Orden',
  'editor.loreOrderPlaceholder': 'Orden',
  'editor.loreConstant': 'Constante',
  'editor.loreSelective': 'Selectivo',
  'editor.loreBeforeChar': 'Antes del pers.',
  'editor.loreAfterChar': 'Después del pers.',
  'editor.loreContent': 'Contenido',
  'editor.loreContentPlaceholder': 'Contenido de la entrada...',
  'editor.loreNewEntry': 'Nueva entrada',
  'error.unknown': 'Error desconocido',
  'error.unexpected': 'Error inesperado: {{message}}',
  'error.requestFailed': 'La solicitud falló: {{message}}',
  'error.unsupportedFile': 'Tipo de archivo no compatible: .{{ext}}',
  'error.invalidJson': 'JSON inválido: {{message}}',
  'error.notPng': 'Archivo PNG no válido',
  'error.unknownFormat': 'Formato de carta desconocido — no es una carta de personaje de SillyTavern',
  'error.fetchModelsFailed': 'No se pudieron obtener los modelos (HTTP {{status}})',
  'error.noChoices': 'La API no devolvió opciones de respuesta',
  'error.emptyResponse': 'Respuesta vacía de la API (sin cuerpo)',
  'gen.newCharacter': 'Nuevo personaje',
  'gen.bytes': ' B',
  'gen.kilobytes': ' KB',
  'gen.megabytes': ' MB',
  'settings.backup': 'Copia de seguridad',
  'settings.restore': 'Restaurar',
  'settings.backupTitle': 'Copiar todas las cartas',
  'settings.restoreTitle': 'Restaurar copia de seguridad',
  'settings.exportTitle': 'Exportar ajustes',
  'settings.importTitle': 'Importar ajustes',
  'settings.modelAuto': 'Automático',
  'settings.modelIdPlaceholder': 'p. ej. deepseek-v4-flash',
  'settings.customModelPlaceholder': 'p. ej. llama-3.2-8b-instruct',
  'settings.namedModelPlaceholder': 'p. ej. {{provider}}-latest',
  'settings.getApiKeyFrom': 'Obtener la clave de API de ',
  'settings.customModelDesc': 'Modelo personalizado',
  'settings.workspaceExported': 'Espacio de trabajo exportado ({{count}} cartas)',
  'settings.invalidWorkspace': 'Formato de espacio de trabajo inválido',
  'settings.workspaceImported': 'Espacio de trabajo importado ({{count}} cartas)',
  'settings.workspaceImportFailed': 'No se pudo importar el espacio de trabajo: {{error}}',
  'nav.brand': 'ST Card Editor',
  'nav.toggleAI': 'Mostrar u ocultar el asistente de IA',
  'nav.toggleAIAria': 'Mostrar u ocultar el asistente de IA',
  'nav.notificationsAria': 'Notificaciones',
  'left.sortCards': 'Ordenar cartas',
  'left.compareSelected': 'Comparar cartas seleccionadas',
  'left.resizeAria': 'Redimensionar la biblioteca de cartas',
  ...
  'wizard.quick': 'Rápido:',
  'wizard.imageSearchPlaceholder': 'Buscar etiquetas: gato, vestido, uniforme, cyberpunk...',
  ...
  'wizard.language.fr': 'Francés',
  'wizard.language.de': 'Alemán',
  'wizard.language.ja': 'Japonés',
  'wizard.language.it': 'Italiano',
  'wizard.language.pl': 'Polaco',
  'wizard.language.tr': 'Turco',
  'wizard.language.nl': 'Neerlandés',
  'wizard.language.uk': 'Ucraniano',
  'wizard.language.vi': 'Vietnamita',
  'wizard.language.id': 'Indonesio',
  'wizard.language.hi': 'Hindi',
  'wizard.language.ar': 'Árabe',
  'wizard.language.he': 'Hebreo',
  'wizard.language.fa': 'Persa',
  'wizard.language.ro': 'Rumano',
  'wizard.language.cs': 'Checo',
  'wizard.language.sv': 'Sueco',
  'wizard.language.th': 'Tailandés',
  'wizard.language.pt-pt': 'Portugués (Portugal)',
  'wizard.language.tl': 'Filipino',
  'search.results': '{{count}} cartas coincidentes',
  'search.capped': 'Mostrando las primeras {{count}} coincidencias — refina tu búsqueda',
  'shortcuts.palette': 'Paleta de comandos',
  'library.reorderHandle': 'Reordenar carta (flechas Arriba/Abajo)',
  'palette.title': 'Paleta de comandos',
  'palette.placeholder': 'Buscar cartas, campos o ejecutar un comando...',
  'palette.hint': '↑↓ navegar · Enter ejecutar · Esc cerrar',
  'palette.empty': 'Ninguna carta, campo o acción coincide',
  'palette.jumpTo': 'Ir a {{field}}',
  'palette.kind.card': 'Carta',
  'palette.kind.field': 'Campo',
  'palette.kind.action': 'Acción',
  ...
  'history.compare': 'Comparar con la actual',
  'history.restore': 'Restaurar',
  'history.restored': 'Versión restaurada',
  'history.comparePrefix': 'Cambios desde ',
  'health.title': 'Salud de la carta',
  'health.ok': 'No se encontraron problemas.',
  'health.noName': 'La carta no tiene nombre.',
  'health.longName': 'El nombre tiene {{length}} caracteres — algunas interfaces cortan a partir de 50.',
  'health.noDescription': 'La carta no tiene descripción.',
  'health.noFirstMes': 'La carta no tiene ni primer mensaje ni saludo alternativo.',
  'health.noTags': 'Sin etiquetas, así que la carta no aparece en los filtros de etiquetas.',
  'health.unknownMacros': 'Las macros desconocidas se enviarán al modelo tal cual: {{names}}.',
  'health.unbalancedMacros': 'Llaves de macro descompensadas: {{open}} abriendo frente a {{close}} cerrando.',
  'health.greetingBudget': 'Todos los saludos suman {{tokens}} tokens, por encima del límite de salida de {{max}}.',
  'health.noSpec': 'Sin versión de spec definida — la carta se exporta como v2.',
  'health.noImage': 'Sin imagen de avatar.',
  'health.loreNoKey': '{{count}} entradas de lorebook no tienen clave y no son constantes, así que nunca se activan.',
  'health.loreNoContent': '{{count}} entradas de lorebook no tienen contenido.',
  'health.loreDuplicateKeys': 'Claves de lorebook duplicadas: {{keys}}.',
  'health.loreActive': '{{count}} entradas de lorebook se activan solo con esta carta; las demás necesitan texto del chat.',
  'palette.results': 'Resultados',
  'toast.langOffline': 'Este paquete de idioma aún no está disponible sin conexión — se muestra en inglés. Se cargará la próxima vez que estés en línea.',
};
