...
export default {
  ...
  'wizard.summary.gender': 'Jenis kelamin',
  ...
  'gen.notAvailable': 'Tidak tersedia',
  ...
  'settings.promptVariables': 'Variabel prompt yang tersedia',
  'settings.varCard': 'Menyisipkan kartu saat ini sebagai JSON ke dalam prompt.',
  'settings.varLang': 'Bahasa tujuan untuk tindakan cepat Terjemahkan.',
  'settings.varTone': 'Nada yang dipilih untuk tindakan cepat Nada.',
  'settings.varCount': 'Jumlah item yang dibuat (misalnya sapaan alternatif).',
  'settings.varCurrent': 'Isi saat ini dari kolom yang sedang diedit.',
  'settings.varField': 'Nama kolom yang sedang diedit.',
  'settings.varChar': 'Nama karakter, digantikan oleh mesin obrolan (SillyTavern).',
  'settings.varUser': 'Nama pengguna, digantikan oleh mesin obrolan (SillyTavern).',
  'ai.thinkingLive': 'Berpikir… {{secs}}',
  'ai.streamLive': '{{tokens}} token · {{secs}}',
  'dialog.ok': 'Oke',
  'editor.extensions': 'Ekstensi (JSON)',
  'editor.extensionsHint': 'Objek `extensions` mentah kartu — JSON. Mengubahnya bisa merusak fitur SillyTavern.',
  'editor.extensionsParseError': 'JSON tidak valid — ekstensi valid terakhir tetap dipakai.',
  'editor.cardTokenTotal': '~{{tokens}} token · {{chars}} karakter',
  'dialog.cancel': 'Batal',
  'dialog.delete': 'Hapus',
  'ai.translateTitle': 'Terjemahkan kartu',
  'ai.translateMessage': 'Kartu ingin diterjemahkan ke bahasa apa?',
  'ai.toneTitle': 'Ubah nada',
  'ai.toneMessage': 'Deskripsi ingin ditulis ulang dengan nada apa?',
  'batch.deleteTitle': 'Hapus {{count}} kartu?',
  ...
  'wizard.language.en': 'Inggris',
  'wizard.language.fr': 'Prancis',
  'wizard.language.de': 'Jerman',
  'wizard.language.ja': 'Jepang',
  'wizard.language.it': 'Italia',
  'wizard.language.pl': 'Polandia',
  'wizard.language.tr': 'Turki',
  'wizard.language.nl': 'Belanda',
  'wizard.language.uk': 'Ukraina',
  'wizard.language.vi': 'Vietnam',
  'wizard.language.id': 'Indonesia',
  'wizard.language.hi': 'Hindi',
  'wizard.language.ar': 'Arab',
  'wizard.language.he': 'Ibrani',
  'wizard.language.fa': 'Persia',
  'wizard.language.ro': 'Rumania',
  'wizard.language.cs': 'Ceko',
  'wizard.language.sv': 'Swedia',
  'wizard.language.th': 'Thailand',
  'wizard.language.pt-pt': 'Portugis (Portugal)',
  'wizard.language.tl': 'Filipino',
  'search.results': '{{count}} kartu cocok',
  'search.capped': 'Menampilkan {{count}} hasil pertama — persempit pencarian',
  'shortcuts.palette': 'Palet perintah',
  'library.reorderHandle': 'Ubah urutan kartu (tombol panah atas/bawah)',
  'palette.title': 'Palet perintah',
  'palette.placeholder': 'Cari kartu, kolom, atau jalankan perintah...',
  'palette.hint': '↑↓ navigasi · Enter jalankan · Esc tutup',
  'palette.empty': 'Tidak ada kartu, kolom, atau tindakan yang cocok',
  'palette.jumpTo': 'Buka {{field}}',
  'palette.kind.card': 'Kartu',
  'palette.kind.field': 'Kolom',
  'palette.kind.action': 'Tindakan',
  'toast.cardsRestored': '{{count}} kartu dipulihkan',
  'history.title': 'Riwayat versi',
  'history.empty': 'Belum ada versi sebelumnya.',
  'history.compare': 'Bandingkan dengan versi saat ini',
  'history.restore': 'Pulihkan',
  'history.restored': 'Versi dipulihkan',
  'history.comparePrefix': 'Perubahan sejak ',
  'health.title': 'Kesehatan kartu',
  'health.ok': 'Tidak ada masalah.',
  'health.noName': 'Kartu tidak memiliki nama.',
  'health.longName': 'Nama berisi {{length}} karakter — sebagian antarmuka memotongnya setelah 50.',
  'health.noDescription': 'Kartu tidak memiliki deskripsi.',
  'health.noFirstMes': 'Kartu tidak memiliki pesan pertama maupun sapaan alternatif.',
  'health.noTags': 'Tidak ada tag, sehingga kartu tidak bisa ditemukan lewat filter tag.',
  'health.unknownMacros': 'Makro tak dikenal akan dikirim ke model apa adanya: {{names}}.',
  'health.unbalancedMacros': 'Kurung makro tidak seimbang: {{open}} pembuka vs {{close}} penutup.',
  'health.greetingBudget': 'Semua sapaan berjumlah {{tokens}} token, melebihi batas keluaran {{max}}.',
  'health.noSpec': 'Versi spec belum diatur — kartu akan diekspor sebagai v2.',
  'health.noImage': 'Tidak ada gambar avatar.',
  'health.loreNoKey': '{{count}} entri lorebook tidak punya kata kunci dan tidak konstan, jadi tidak akan pernah terpicu.',
  'health.loreNoContent': '{{count}} entri lorebook tidak memiliki isi.',
  'health.loreDuplicateKeys': 'Kata kunci lorebook duplikat: {{keys}}.',
  'health.loreActive': '{{count}} entri lorebook terpicu hanya dari kartu ini; sisanya butuh teks obrolan.',
  'palette.results': 'Hasil',
  'toast.langOffline': 'Paket bahasa itu belum tersedia offline — kami tampilkan bahasa Inggris. Paket akan dimuat saat Anda kembali online.',
};
