...
export default {
  ...
  'settings.promptVariables': 'Kullanılabilir prompt değişkenleri',
  'settings.varCard': 'Geçerli kartı JSON olarak prompta ekler.',
  'settings.varLang': 'Çevir hızlı eylemi için hedef dil.',
  'settings.varTone': 'Ton hızlı eyleminin uyguladığı ton.',
  'settings.varCount': 'Üretilecek öğe sayısı (örn. alternatif karşılamalar).',
  'settings.varCurrent': 'Düzenlenen alanın geçerli içeriği.',
  'settings.varField': 'Düzenlenen alanın adı.',
  'settings.varChar': 'Karakter adı; sohbet motoru (SillyTavern) tarafından değiştirilir.',
  'settings.varUser': 'Kullanıcı adı; sohbet motoru (SillyTavern) tarafından değiştirilir.',
  'ai.thinkingLive': 'Düşünüyor… {{secs}}',
  'ai.streamLive': '{{tokens}} token · {{secs}}',
  'dialog.ok': 'Tamam',
  'editor.extensions': 'Uzantılar (JSON)',
  'editor.extensionsHint': 'Kartın ham `extensions` nesnesi — JSON. Düzenlemek SillyTavern özelliklerini bozabilir.',
  'editor.extensionsParseError': 'Geçersiz JSON — son geçerli uzantılar korunuyor.',
  ...
  'wizard.language.en': 'İngilizce',
  'wizard.language.fr': 'Fransızca',
  'wizard.language.de': 'Almanca',
  'wizard.language.ja': 'Japonca',
  'wizard.language.it': 'İtalyanca',
  'wizard.language.pl': 'Lehçe',
  'wizard.language.tr': 'Türkçe',
  'wizard.language.nl': 'Felemenkçe',
  'wizard.language.uk': 'Ukraynaca',
  'wizard.language.vi': 'Vietnamca',
  'wizard.language.id': 'Endonezce',
  'wizard.language.hi': 'Hintçe',
  'wizard.language.ar': 'Arapça',
  'wizard.language.he': 'İbranice',
  'wizard.language.fa': 'Farsça',
  'wizard.language.ro': 'Rumence',
  'wizard.language.cs': 'Çekçe',
  'wizard.language.sv': 'İsveççe',
  'wizard.language.th': 'Tayca',
  'wizard.language.pt-pt': 'Portekizce (Portekiz)',
  'wizard.language.tl': 'Filipince',
  'search.results': '{{count}} eşleşen kart',
  'search.capped': 'İlk {{count}} sonuç gösteriliyor — aramayı daraltın',
  'shortcuts.palette': 'Komut paleti',
  'library.reorderHandle': 'Kartın sırasını değiştir (yukarı/aşağı okları)',
  'palette.title': 'Komut paleti',
  'palette.placeholder': 'Kart, alan ara veya bir komut çalıştır...',
  'palette.hint': '↑↓ gezin · Enter çalıştır · Esc kapat',
  'palette.empty': 'Eşleşen kart, alan veya eylem yok',
  'palette.jumpTo': '{{field}} alanına git',
  'palette.kind.card': 'Kart',
  'palette.kind.field': 'Alan',
  'palette.kind.action': 'Eylem',
  'toast.cardsRestored': '{{count}} kart geri yüklendi',
  'history.title': 'Sürüm geçmişi',
  'history.empty': 'Henüz önceki sürüm yok.',
  'history.compare': 'Geçerli sürümle karşılaştır',
  'history.restore': 'Geri yükle',
  'history.restored': 'Sürüm geri yüklendi',
  'history.comparePrefix': 'Şu tarihten beri değişiklikler: ',
  'health.title': 'Kart sağlığı',
  'health.ok': 'Sorun bulunamadı.',
  'health.noName': 'Kartın adı yok.',
  'health.longName': 'Ad {{length}} karakter — bazı arayüzler 50\'den sonrasını keser.',
  'health.noDescription': 'Kartın açıklaması yok.',
  'health.noFirstMes': 'Kartta ne ilk mesaj ne de alternatif karşılama var.',
  'health.noTags': 'Etiket yok, bu yüzden kart etiket filtreleriyle bulunamaz.',
  'health.unknownMacros': 'Bilinmeyen makrolar modele olduğu gibi gönderilecek: {{names}}.',
  'health.unbalancedMacros': 'Dengesiz makro süslü parantezleri: {{open}} açılan, {{close}} kapanan.',
  'health.greetingBudget': 'Tüm karşılamalar toplam {{tokens}} token — {{max}} çıktı sınırının üzerinde.',
  'health.noSpec': 'spec sürümü ayarlanmamış — kart v2 olarak dışa aktarılır.',
  'health.noImage': 'Avatar görseli yok.',
  'health.loreNoKey': '{{count}} lorebook girdisinin anahtarı yok ve sabit de değiller, bu yüzden hiç tetiklenmezler.',
  'health.loreNoContent': '{{count}} lorebook girdisinin içeriği yok.',
  'health.loreDuplicateKeys': 'Yinelenen lorebook anahtarları: {{keys}}.',
  'health.loreActive': '{{count}} lorebook girdisi yalnızca bu kartla tetikleniyor; kalanlar sohbet metnine ihtiyaç duyar.',
  'palette.results': 'Sonuçlar',
  'toast.langOffline': 'Bu dil paketi henüz çevrimdışı kullanılamıyor — İngilizce gösteriliyor. Bir sonraki çevrimiçi oluşunuzda yüklenecek.',
};
