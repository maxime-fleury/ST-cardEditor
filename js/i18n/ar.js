...
export default {
  ...
  'settings.promptVariables': 'متغيرات الأمر المتاحة',
  'settings.varCard': 'يُدرج البطاقة الحالية بصيغة JSON في الأمر.',
  'settings.varLang': 'اللغة الهدف لإجراء الترجمة السريع.',
  'settings.varTone': 'النبرة المختارة في إجراء النبرة السريع.',
  'settings.varCount': 'عدد العناصر المطلوب إنشاؤها (مثل التحيات البديلة).',
  'settings.varCurrent': 'المحتوى الحالي للحقل قيد التحرير.',
  'settings.varField': 'اسم الحقل قيد التحرير.',
  'settings.varChar': 'اسم الشخصية، يستبدله محرك المحادثة (SillyTavern).',
  'settings.varUser': 'اسم المستخدم، يستبدله محرك المحادثة (SillyTavern).',
  'ai.thinkingLive': 'يفكّر… {{secs}}',
  'ai.streamLive': '{{tokens}} رمز · {{secs}}',
  'dialog.ok': 'حسنًا',
  'editor.extensions': 'الإضافات (JSON)',
  'editor.extensionsHint': 'كائن `extensions` الخام للبطاقة — JSON. قد يؤدي تعديله إلى تعطّل ميزات SillyTavern.',
  'editor.extensionsParseError': 'JSON غير صالح — سيتم الإبقاء على آخر إضافات صالحة.',
  'editor.cardTokenTotal': '~{{tokens}} رمز · {{chars}} حرفًا',
  'dialog.cancel': 'إلغاء',
  'dialog.delete': 'حذف',
  'ai.translateTitle': 'ترجمة البطاقة',
  'ai.translateMessage': 'إلى أي لغة تُترجم البطاقة؟',
  'ai.toneTitle': 'تغيير النبرة',
  'ai.toneMessage': 'بأي نبرة تُعاد كتابة الوصف؟',
  'batch.deleteTitle': 'حذف {{count}} بطاقة؟',
  'settings.clearTitle': 'حذف كل البيانات؟',
  ...
  'wizard.language.en': 'الإنجليزية',
  'wizard.language.fr': 'الفرنسية',
  'wizard.language.de': 'الألمانية',
  'wizard.language.ja': 'اليابانية',
  'wizard.language.it': 'الإيطالية',
  'wizard.language.pl': 'البولندية',
  'wizard.language.tr': 'التركية',
  'wizard.language.nl': 'الهولندية',
  'wizard.language.uk': 'الأوكرانية',
  'wizard.language.vi': 'الفيتنامية',
  'wizard.language.id': 'الإندونيسية',
  'wizard.language.hi': 'الهندية',
  'wizard.language.ar': 'العربية',
  'wizard.language.he': 'العبرية',
  'wizard.language.fa': 'الفارسية',
  'wizard.language.ro': 'الرومانية',
  'wizard.language.cs': 'التشيكية',
  'wizard.language.sv': 'السويدية',
  'wizard.language.th': 'التايلاندية',
  'wizard.language.pt-pt': 'البرتغالية (البرتغال)',
  'wizard.language.tl': 'الفلبينية',
  'search.results': '{{count}} بطاقة مطابقة',
  'search.capped': 'يتم عرض أول {{count}} نتيجة — ضيّق نطاق البحث',
  'shortcuts.palette': 'لوحة الأوامر',
  'library.reorderHandle': 'إعادة ترتيب البطاقة (مفتاحا الأعلى/الأسفل)',
  'palette.title': 'لوحة الأوامر',
  'palette.placeholder': 'ابحث عن بطاقات أو حقول أو نفّذ أمرًا...',
  'palette.hint': '↑↓ تنقّل · Enter تنفيذ · Esc إغلاق',
  'palette.empty': 'لا توجد بطاقة أو حقل أو إجراء مطابق',
  'palette.jumpTo': 'الانتقال إلى {{field}}',
  'palette.kind.card': 'بطاقة',
  'palette.kind.field': 'حقل',
  'palette.kind.action': 'إجراء',
  'toast.cardsRestored': 'تمت استعادة {{count}} بطاقة',
  'history.title': 'سجل الإصدارات',
  'history.empty': 'لا توجد إصدارات سابقة بعد.',
  'history.compare': 'قارن بالإصدار الحالي',
  'history.restore': 'استعادة',
  'history.restored': 'تمت استعادة الإصدار',
  'history.comparePrefix': 'التغييرات منذ ',
  'health.title': 'حالة البطاقة',
  'health.ok': 'لم يتم العثور على مشكلات.',
  'health.noName': 'لا يوجد اسم للبطاقة.',
  'health.longName': 'الاسم بطول {{length}} حرفًا — بعض الواجهات تقتطعه بعد 50.',
  'health.noDescription': 'لا يوجد وصف للبطاقة.',
  'health.noFirstMes': 'لا تحتوي البطاقة على رسالة أولى ولا على تحية بديلة.',
  'health.noTags': 'لا توجد وسوم، لذا لا يمكن العثور على البطاقة عبر مرشحات الوسوم.',
  'health.unknownMacros': 'سيتم إرسال الماكرو غير المعروف إلى النموذج كما هو: {{names}}.',
  'health.unbalancedMacros': 'أقواس الماكرو غير متوازنة: {{open}} فتح مقابل {{close}} إغلاق.',
  'health.greetingBudget': 'مجموع التحيات {{tokens}} رمزًا، وهو يتجاوز حد الإخراج {{max}}.',
  'health.noSpec': 'لم يتم تعيين إصدار spec — ستُصدَّر البطاقة كـ v2.',
  'health.noImage': 'لا توجد صورة رمزية.',
  'health.loreNoKey': '{{count}} من مدخلات دفتر المعرفة بلا مفتاح وغير ثابتة، لذا لن تُفعَّل أبدًا.',
  'health.loreNoContent': '{{count}} من مدخلات دفتر المعرفة بلا محتوى.',
  'health.loreDuplicateKeys': 'مفاتيح دفتر المعرفة مكررة: {{keys}}.',
  'health.loreActive': '{{count}} من مدخلات دفتر المعرفة تُفعَّل بهذه البطاقة وحدها؛ أما البقية فتحتاج نص المحادثة.',
  'palette.results': 'النتائج',
  'toast.langOffline': 'حزمة اللغة هذه غير متاحة دون اتصال بعد — نعرض الإنجليزية الآن. ستُحمَّل عند عودتك إلى الإنترنت.',
};
