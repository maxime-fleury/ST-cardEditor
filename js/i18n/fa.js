...
export default {
  ...
  'settings.promptVariables': 'متغیرهای پرامپت در دسترس',
  'settings.varCard': 'کارت کنونی را به‌صورت JSON در پرامپت درج می‌کند.',
  'settings.varLang': 'زبان هدف برای اقدام سریع ترجمه.',
  'settings.varTone': 'لحن انتخاب‌شده در اقدام سریع لحن.',
  'settings.varCount': 'تعداد موارد برای تولید (مثلاً سلام‌های جایگزین).',
  'settings.varCurrent': 'محتوای کنونی فیلد در حال ویرایش.',
  'settings.varField': 'نام فیلد در حال ویرایش.',
  'settings.varChar': 'نام شخصیت، که موتور گفتگو (SillyTavern) جایگزین می‌کند.',
  'settings.varUser': 'نام کاربر، که موتور گفتگو (SillyTavern) جایگزین می‌کند.',
  'ai.thinkingLive': 'در حال فکر… {{secs}}',
  'ai.streamLive': '{{tokens}} توکن · {{secs}}',
  'dialog.ok': 'تأیید',
  'editor.extensions': 'افزونه‌ها (JSON)',
  'editor.extensionsHint': 'شیء خام `extensions` کارت — JSON. ویرایش آن ممکن است قابلیت‌های SillyTavern را از کار بیندازد.',
  'editor.extensionsParseError': 'JSON نامعتبر — آخرین افزونه‌های معتبر حفظ می‌شود.',
  'editor.cardTokenTotal': '~{{tokens}} توکن · {{chars}} کاراکتر',
  'dialog.cancel': 'لغو',
  'dialog.delete': 'حذف',
  'ai.translateTitle': 'ترجمه کارت',
  'ai.translateMessage': 'کارت به چه زبانی ترجمه شود؟',
  'ai.toneTitle': 'تغییر لحن',
  'ai.toneMessage': 'توضیح با چه لحنی بازنویسی شود؟',
  'batch.deleteTitle': 'حذف {{count}} کارت؟',
  'settings.clearTitle': 'همه داده‌ها پاک شود؟',
  ...
  'wizard.language.en': 'انگلیسی',
  'wizard.language.fr': 'فرانسوی',
  'wizard.language.de': 'آلمانی',
  'wizard.language.ja': 'ژاپنی',
  'wizard.language.it': 'ایتالیایی',
  'wizard.language.pl': 'لهستانی',
  'wizard.language.tr': 'ترکی',
  'wizard.language.nl': 'هلندی',
  'wizard.language.uk': 'اوکراینی',
  'wizard.language.vi': 'ویتنامی',
  'wizard.language.id': 'اندونزیایی',
  'wizard.language.hi': 'هندی',
  'wizard.language.ar': 'عربی',
  'wizard.language.he': 'عبری',
  'wizard.language.fa': 'فارسی',
  'wizard.language.ro': 'رومانیایی',
  'wizard.language.cs': 'چکی',
  'wizard.language.sv': 'سوئدی',
  'wizard.language.th': 'تایلندی',
  'wizard.language.pt-pt': 'پرتغالی (پرتغال)',
  'wizard.language.tl': 'فیلیپینی',
  'search.results': '{{count}} کارت مطابق',
  'search.capped': 'نمایش {{count}} نتیجه نخست — جست‌وجو را محدودتر کنید',
  'shortcuts.palette': 'پالت فرمان‌ها',
  'library.reorderHandle': 'تغییر ترتیب کارت (کلیدهای بالا/پایین)',
  'palette.title': 'پالت فرمان‌ها',
  'palette.placeholder': 'کارت‌ها یا فیلدها را جست‌وجو کنید یا فرمانی را اجرا کنید...',
  'palette.hint': '↑↓ پیمایش · Enter اجرا · Esc بستن',
  'palette.empty': 'کارت، فیلد یا عملی مطابق پیدا نشد',
  'palette.jumpTo': 'رفتن به {{field}}',
  'palette.kind.card': 'کارت',
  'palette.kind.field': 'فیلد',
  'palette.kind.action': 'عملیات',
  'toast.cardsRestored': '{{count}} کارت بازیابی شد',
  'history.title': 'تاریخچه نسخه‌ها',
  'history.empty': 'هنوز نسخه پیشینی وجود ندارد.',
  'history.compare': 'مقایسه با نسخه کنونی',
  'history.restore': 'بازیابی',
  'history.restored': 'نسخه بازیابی شد',
  'history.comparePrefix': 'تغییرات از ',
  'health.title': 'وضعیت کارت',
  'health.ok': 'مشکلی پیدا نشد.',
  'health.noName': 'کارت نامی ندارد.',
  'health.longName': 'نام {{length}} کاراکتر است — برخی رابط‌ها پس از ۵۰ کاراکتر آن را می‌بُرند.',
  'health.noDescription': 'کارت توضیحی ندارد.',
  'health.noFirstMes': 'کارت نه پیام اول دارد و نه سلام جایگزین.',
  'health.noTags': 'برچسبی وجود ندارد، بنابراین کارت از طریق فیلتر برچسب‌ها پیدا نمی‌شود.',
  'health.unknownMacros': 'ماکروهای ناشناخته همان‌گونه به مدل فرستاده می‌شوند: {{names}}.',
  'health.unbalancedMacros': 'آکولادهای ماکرو نامتوازن هستند: {{open}} بازکننده در برابر {{close}} بستن.',
  'health.greetingBudget': 'مجموع سلام‌ها {{tokens}} توکن است، بیشتر از سقف خروجی {{max}}.',
  'health.noSpec': 'نسخه spec تعیین نشده — کارت به‌صورت v2 برون‌ریزی می‌شود.',
  'health.noImage': 'تصویر آواتار وجود ندارد.',
  'health.loreNoKey': '{{count}} مدخل لوربوک کلید ندارند و ثابت هم نیستند، بنابراین هرگز فعال نمی‌شوند.',
  'health.loreNoContent': '{{count}} مدخل لوربوک محتوا ندارند.',
  'health.loreDuplicateKeys': 'کلیدهای تکراری لوربوک: {{keys}}.',
  'health.loreActive': '{{count}} مدخل لوربوک فقط با همین کارت فعال می‌شوند؛ بقیه به متن گفتگو نیاز دارند.',
  'palette.results': 'نتایج',
  'toast.langOffline': 'بسته زبان هنوز به‌صورت آفلاین در دسترس نیست — فعلاً انگلیسی نمایش داده می‌شود. دفعه بعد که آنلاین شوید بارگذاری می‌شود.',
};
