...
export default {
  ...
  'ai.apply': '적용',
  'ai.applyTitle': '이 변경 사항을 카드에 적용',
  'ai.errorPrefix': '오류: ',
  'ai.translatePrompt': '어떤 언어로 번역할까요?',
  'ai.translateDefaultLang': '한국어',
  'ai.tonePrompt': '어떤 어조로 할까요? (예: 격식체, 캐주얼, 어두운, 유머러스, 시적)',
  'ai.toneDefault': '격식체',
  'ai.chatSession': '채팅 세션',
  'ai.msgs': '{{count}}개 메시지',
  'ai.tokensIn': ' 입력 · ',
  'ai.tokensOut': ' 출력 · ',
  'ai.tokensCtx': ' 컨텍스트',
  'ai.exceedsLimit': ' ⚠ 한도 초과!',
  'ai.approachingLimit': ' ⚠ 한도에 근접',
  'ai.count': '개수:',
  'ai.resizeAria': 'AI 어시스턴트 크기 조절',
  'ai.chatMessagesAria': 'AI 채팅 메시지',
  'ai.mesExamplePlaceholder': '<START>\n{{char}}: 여기에 대화 예시를 작성하세요...\n{{user}}: 사용자 응답...\n<START>\n{{char}}: 또 다른 예시...',
  'batch.select2ForCompare': '비교할 카드를 정확히 2개 선택하세요',
  'batch.compareLoadFailed': '비교할 카드를 불러오지 못했습니다',
  'batch.comparePrefix': '비교: ',
  'batch.compareVs': ' 대 ',
  'batch.cardA': '카드 A',
  'batch.cardB': '카드 B',
  'editor.charCount': '{{chars}}자 ~{{tokens}} 토큰',
  'editor.counterWarn': '출력 토큰 한도에 가까워짐 ({{tokens}}/{{max}}).',
  'editor.counterDanger': '출력 토큰 한도 초과 ({{tokens}}/{{max}}).',
  'settings.promptVariables': '사용 가능한 프롬프트 변수',
  'settings.varCard': '현재 카드를 JSON으로 프롬프트에 삽입합니다.',
  'settings.varLang': '번역 빠른 작업의 대상 언어.',
  'settings.varTone': '어조 빠른 작업에서 적용할 어조.',
  'settings.varCount': '생성할 항목 수(예: 대체 인사말).',
  'settings.varCurrent': '편집 중인 필드의 현재 내용.',
  'settings.varField': '편집 중인 필드 이름.',
  'settings.varChar': '캐릭터 이름. 채팅 엔진(SillyTavern)이 치환합니다.',
  'settings.varUser': '사용자 이름. 채팅 엔진(SillyTavern)이 치환합니다.',
  'ai.thinkingLive': '생각 중… {{secs}}',
  'ai.streamLive': '{{tokens}} 토큰 · {{secs}}',
  'dialog.ok': '확인',
  'editor.extensions': '확장(JSON)',
  'editor.extensionsHint': '카드의 원본 `extensions` 객체 — JSON. 수정하면 SillyTavern 기능이 깨질 수 있습니다.',
  'editor.extensionsParseError': 'JSON이 올바르지 않습니다 — 마지막으로 유효했던 확장을 유지합니다.',
  'editor.cardTokenTotal': '약 {{tokens}} 토큰 · {{chars}}자',
  'dialog.cancel': '취소',
  'dialog.delete': '삭제',
  'ai.translateTitle': '카드 번역',
  'ai.translateMessage': '카드를 어떤 언어로 번역할까요?',
  'ai.toneTitle': '어조 변경',
  'ai.toneMessage': '설명을 어떤 어조로 다시 쓸까요?',
  'batch.deleteTitle': '카드 {{count}}개를 삭제할까요?',
  'settings.clearTitle': '모든 데이터를 지울까요?',
  'editor.greetingMoveUp': '위로 이동',
  'editor.greetingMoveDown': '아래로 이동',
  'editor.greetingIsDefault': '현재 첫 메시지입니다',
  'editor.greetingSetDefault': '첫 메시지로 설정',
  'editor.greetingRemove': '제거',
  'editor.greetingPlaceholder': '인사말 {{num}}...',
  'editor.loreEntry': '항목 {{num}}',
  'editor.loreDeleteEntry': '항목 삭제',
  'editor.lorePrimaryKeys': '기본 키워드',
  'editor.lorePrimaryKeysPlaceholder': '기본 키워드 — 쉼표로 구분',
  'editor.loreSecondaryKeys': '보조 키워드',
  'editor.loreSecondaryKeysPlaceholder': '보조 키워드',
  'editor.loreComment': '코멘트',
  'editor.loreCommentPlaceholder': '코멘트',
  'editor.loreOrder': '순서',
  'editor.loreOrderPlaceholder': '순서',
  'editor.loreConstant': '상시 활성',
  'editor.loreSelective': '선택적',
  'editor.loreBeforeChar': '캐릭터 앞',
  'editor.loreAfterChar': '캐릭터 뒤',
  'editor.loreContent': '내용',
  'editor.loreContentPlaceholder': '항목 내용...',
  'editor.loreNewEntry': '새 항목',
  'error.unknown': '알 수 없는 오류',
  'error.unexpected': '예기치 않은 오류: {{message}}',
  'error.requestFailed': '요청 실패: {{message}}',
  'error.unsupportedFile': '지원하지 않는 파일 형식입니다: .{{ext}}',
  'error.invalidJson': 'JSON이 올바르지 않습니다: {{message}}',
  'error.notPng': '유효한 PNG 파일이 아닙니다',
  'error.unknownFormat': '알 수 없는 카드 형식입니다 — SillyTavern 캐릭터 카드가 아닙니다',
  'error.fetchModelsFailed': '모델을 가져오지 못했습니다(HTTP {{status}})',
  'error.noChoices': 'API가 응답 선택지를 반환하지 않았습니다',
  'error.emptyResponse': 'API 응답이 비어 있습니다(본문 없음)',
  'gen.newCharacter': '새 캐릭터',
  'gen.bytes': ' B',
  'gen.kilobytes': ' KB',
  'gen.megabytes': ' MB',
  'settings.backup': '백업',
  'settings.restore': '복원',
  'settings.backupTitle': '모든 카드 백업',
  'settings.restoreTitle': '백업 복원',
  'settings.exportTitle': '설정 내보내기',
  'settings.importTitle': '설정 가져오기',
  'settings.modelAuto': '자동',
  'settings.modelIdPlaceholder': '예: deepseek-v4-flash',
  'settings.customModelPlaceholder': '예: llama-3.2-8b-instruct',
  'settings.namedModelPlaceholder': '예: {{provider}}-latest',
  'settings.getApiKeyFrom': 'API 키 발급처: ',
  'settings.customModelDesc': '사용자 지정 모델',
  'settings.workspaceExported': '워크스페이스를 내보냈습니다(카드 {{count}}개)',
  'settings.invalidWorkspace': '워크스페이스 형식이 올바르지 않습니다',
  'settings.workspaceImported': '워크스페이스를 가져왔습니다(카드 {{count}}개)',
  'settings.workspaceImportFailed': '워크스페이스를 가져오지 못했습니다: {{error}}',
  'nav.brand': 'ST Card Editor',
  'nav.toggleAI': 'AI 어시스턴트 표시 전환',
  'nav.toggleAIAria': 'AI 어시스턴트 표시 전환',
  'nav.notificationsAria': '알림',
  'left.sortCards': '카드 정렬',
  'left.compareSelected': '선택한 카드 비교',
  'left.resizeAria': '카드 라이브러리 크기 조절',
  'left.cardListAria': '카드 라이브러리',
  'ui.saved': ' 저장됨',
  'ui.collapsePanel': '패널 접기',
  'ui.expandPanel': '패널 펼치기',
  'ui.cardModified': '저장되지 않은 변경',
  'export.minimalPngLabel': 'ST 카드',
  'wizard.search': '검색',
  'wizard.quick': '빠른 선택:',
  'wizard.imageSearchPlaceholder': '태그 검색: cat, dress, uniform, cyberpunk...',
  ...
  'wizard.language.en': '영어',
  'wizard.language.fr': '프랑스어',
  'wizard.language.de': '독일어',
  'wizard.language.ja': '일본어',
  'wizard.language.it': '이탈리아어',
  'wizard.language.pl': '폴란드어',
  'wizard.language.tr': '터키어',
  'wizard.language.nl': '네덜란드어',
  'wizard.language.uk': '우크라이나어',
  'wizard.language.vi': '베트남어',
  'wizard.language.id': '인도네시아어',
  'wizard.language.hi': '힌디어',
  'wizard.language.ar': '아랍어',
  'wizard.language.he': '히브리어',
  'wizard.language.fa': '페르시아어',
  'wizard.language.ro': '루마니아어',
  'wizard.language.cs': '체코어',
  'wizard.language.sv': '스웨덴어',
  'wizard.language.th': '태국어',
  'wizard.language.pt-pt': '포르투갈어(포르투갈)',
  'wizard.language.tl': '필리핀어',
  'search.results': '일치하는 카드 {{count}}개',
  'search.capped': '처음 {{count}}개만 표시합니다 — 검색을 좁혀 보세요',
  'shortcuts.palette': '명령 팔레트',
  'library.reorderHandle': '카드 순서 변경(위/아래 화살표)',
  'palette.title': '명령 팔레트',
  'palette.placeholder': '카드나 필드를 검색하거나 명령을 실행하세요...',
  'palette.hint': '↑↓ 이동 · Enter 실행 · Esc 닫기',
  'palette.empty': '일치하는 카드, 필드 또는 동작이 없습니다',
  'palette.jumpTo': '{{field}}(으)로 이동',
  'palette.kind.card': '카드',
  'palette.kind.field': '필드',
  'palette.kind.action': '동작',
  'toast.cardsRestored': '카드 {{count}}개를 복원했습니다',
  'history.title': '버전 기록',
  'history.empty': '아직 이전 버전이 없습니다.',
  'history.compare': '현재 버전과 비교',
  'history.restore': '복원',
  'history.restored': '버전을 복원했습니다',
  'history.comparePrefix': '이 시점 이후 변경: ',
  'health.title': '카드 상태',
  'health.ok': '문제를 찾지 못했습니다.',
  'health.noName': '카드에 이름이 없습니다.',
  'health.longName': '이름이 {{length}}자입니다 — 50자를 넘으면 일부 UI에서 잘립니다.',
  'health.noDescription': '카드에 설명이 없습니다.',
  'health.noFirstMes': '카드에 첫 메시지도, 대체 인사말도 없습니다.',
  'health.noTags': '태그가 없어 태그 필터로 카드를 찾을 수 없습니다.',
  'health.unknownMacros': '알 수 없는 매크로는 그대로 모델에 전송됩니다: {{names}}.',
  'health.unbalancedMacros': '매크로 중괄호가 맞지 않습니다: 여는 괄호 {{open}}개, 닫는 괄호 {{close}}개.',
  'health.greetingBudget': '모든 인사말을 합치면 {{tokens}} 토큰으로, 출력 한도 {{max}}를 초과합니다.',
  'health.noSpec': 'spec 버전이 설정되지 않았습니다 — 카드는 v2로 내보내집니다.',
  'health.noImage': '아바타 이미지가 없습니다.',
  'health.loreNoKey': '로어북 항목 {{count}}개에 키가 없고 상시 활성도 아니어서 절대 발동하지 않습니다.',
  'health.loreNoContent': '로어북 항목 {{count}}개에 내용이 없습니다.',
  'health.loreDuplicateKeys': '로어북 키가 중복됩니다: {{keys}}.',
  'health.loreActive': '로어북 항목 {{count}}개는 이 카드만으로 발동합니다. 나머지는 채팅 본문이 필요합니다.',
  'palette.results': '결과',
  'toast.langOffline': '해당 언어 팩은 아직 오프라인에서 사용할 수 없습니다 — 영어로 표시합니다. 다음에 온라인일 때 불러옵니다.',
};
