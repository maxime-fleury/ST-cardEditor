...
export default {
  ...
  'settings.promptVariables': 'Các biến prompt khả dụng',
  'settings.varCard': 'Chèn thẻ hiện tại dưới dạng JSON vào prompt.',
  'settings.varLang': 'Ngôn ngữ đích cho thao tác nhanh Dịch.',
  'settings.varTone': 'Giọng điệu đã chọn cho thao tác nhanh Giọng điệu.',
  'settings.varCount': 'Số mục cần tạo (ví dụ: lời chào thay thế).',
  'settings.varCurrent': 'Nội dung hiện tại của trường đang sửa.',
  'settings.varField': 'Tên trường đang sửa.',
  'settings.varChar': 'Tên nhân vật, do công cụ trò chuyện (SillyTavern) thay thế.',
  'settings.varUser': 'Tên người dùng, do công cụ trò chuyện (SillyTavern) thay thế.',
  'ai.thinkingLive': 'Đang suy nghĩ… {{secs}}',
  'ai.streamLive': '{{tokens}} token · {{secs}}',
  'dialog.ok': 'Đồng ý',
  'editor.extensions': 'Phần mở rộng (JSON)',
  'editor.extensionsHint': 'Đối tượng `extensions` thô của thẻ — JSON. Sửa nó có thể làm hỏng tính năng của SillyTavern.',
  'editor.extensionsParseError': 'JSON không hợp lệ — giữ lại phần mở rộng hợp lệ gần nhất.',
  'editor.cardTokenTotal': '~{{tokens}} token · {{chars}} ký tự',
  'dialog.cancel': 'Hủy',
  'dialog.delete': 'Xóa',
  'ai.translateTitle': 'Dịch thẻ',
  'ai.translateMessage': 'Muốn dịch thẻ sang ngôn ngữ nào?',
  'ai.toneTitle': 'Đổi giọng điệu',
  'ai.toneMessage': 'Muốn viết lại mô tả bằng giọng điệu nào?',
  'batch.deleteTitle': 'Xóa {{count}} thẻ?',
  'settings.clearTitle': 'Xóa toàn bộ dữ liệu?',
  ...
  'wizard.language.en': 'Tiếng Anh',
  'wizard.language.fr': 'Tiếng Pháp',
  'wizard.language.de': 'Tiếng Đức',
  'wizard.language.ja': 'Tiếng Nhật',
  'wizard.language.it': 'Tiếng Ý',
  'wizard.language.pl': 'Tiếng Ba Lan',
  'wizard.language.tr': 'Tiếng Thổ Nhĩ Kỳ',
  'wizard.language.nl': 'Tiếng Hà Lan',
  'wizard.language.uk': 'Tiếng Ukraina',
  'wizard.language.vi': 'Tiếng Việt',
  'wizard.language.id': 'Tiếng Indonesia',
  'wizard.language.hi': 'Tiếng Hindi',
  'wizard.language.ar': 'Tiếng Ả Rập',
  'wizard.language.he': 'Tiếng Do Thái',
  'wizard.language.fa': 'Tiếng Ba Tư',
  'wizard.language.ro': 'Tiếng Romania',
  'wizard.language.cs': 'Tiếng Séc',
  'wizard.language.sv': 'Tiếng Thụy Điển',
  'wizard.language.th': 'Tiếng Thái',
  'wizard.language.pt-pt': 'Tiếng Bồ Đào Nha (Bồ Đào Nha)',
  'wizard.language.tl': 'Tiếng Philippines',
  'search.results': '{{count}} thẻ khớp',
  'search.capped': 'Đang hiện {{count}} kết quả đầu tiên — hãy thu hẹp tìm kiếm',
  'shortcuts.palette': 'Bảng lệnh',
  'library.reorderHandle': 'Đổi thứ tự thẻ (phím mũi tên lên/xuống)',
  'palette.title': 'Bảng lệnh',
  'palette.placeholder': 'Tìm thẻ, trường hoặc chạy một lệnh...',
  'palette.hint': '↑↓ di chuyển · Enter chạy · Esc đóng',
  'palette.empty': 'Không có thẻ, trường hay hành động nào khớp',
  'palette.jumpTo': 'Đi tới {{field}}',
  'palette.kind.card': 'Thẻ',
  'palette.kind.field': 'Trường',
  'palette.kind.action': 'Hành động',
  'toast.cardsRestored': 'Đã khôi phục {{count}} thẻ',
  'history.title': 'Lịch sử phiên bản',
  'history.empty': 'Chưa có phiên bản trước đó.',
  'history.compare': 'So sánh với bản hiện tại',
  'history.restore': 'Khôi phục',
  'history.restored': 'Đã khôi phục phiên bản',
  'history.comparePrefix': 'Thay đổi kể từ ',
  'health.title': 'Tình trạng thẻ',
  'health.ok': 'Không tìm thấy vấn đề nào.',
  'health.noName': 'Thẻ chưa có tên.',
  'health.longName': 'Tên dài {{length}} ký tự — một số giao diện sẽ cắt bớt sau 50 ký tự.',
  'health.noDescription': 'Thẻ chưa có mô tả.',
  'health.noFirstMes': 'Thẻ không có tin nhắn đầu tiên lẫn lời chào thay thế.',
  'health.noTags': 'Không có tag nên không thể tìm thấy thẻ qua bộ lọc tag.',
  'health.unknownMacros': 'Các macro không xác định sẽ được gửi nguyên trạng tới mô hình: {{names}}.',
  'health.unbalancedMacros': 'Dấu ngoặc macro không cân đối: {{open}} dấu mở so với {{close}} dấu đóng.',
  'health.greetingBudget': 'Tổng các lời chào là {{tokens}} token, vượt giới hạn đầu ra {{max}}.',
  'health.noSpec': 'Chưa đặt phiên bản spec — thẻ sẽ được xuất dưới dạng v2.',
  'health.noImage': 'Không có ảnh đại diện.',
  'health.loreNoKey': '{{count}} mục lorebook không có từ khóa và không phải hằng số nên sẽ không bao giờ kích hoạt.',
  'health.loreNoContent': '{{count}} mục lorebook không có nội dung.',
  'health.loreDuplicateKeys': 'Từ khóa lorebook trùng lặp: {{keys}}.',
  'health.loreActive': '{{count}} mục lorebook kích hoạt chỉ nhờ thẻ này; số còn lại cần văn bản trò chuyện.',
  'palette.results': 'Kết quả',
  'toast.langOffline': 'Gói ngôn ngữ đó chưa dùng được ngoại tuyến — tạm hiển thị tiếng Anh. Gói sẽ được tải khi bạn trực tuyến trở lại.',
};
