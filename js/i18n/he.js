...
export default {
  ...
  'settings.promptVariables': 'משתני פרומפט זמינים',
  'settings.varCard': 'מכניס את הכרטיס הנוכחי כ-JSON לפרומפט.',
  'settings.varLang': 'שפת היעד לפעולה המהירה תרגום.',
  'settings.varTone': 'הטון שנבחר בפעולה המהירה טון.',
  'settings.varCount': 'מספר הפריטים ליצירה (למשל ברכות חלופיות).',
  'settings.varCurrent': 'התוכן הנוכחי של השדה שנערך.',
  'settings.varField': 'שם השדה שנערך.',
  'settings.varChar': 'שם הדמות, מוחלף בידי מנוע הצ׳אט (SillyTavern).',
  'settings.varUser': 'שם המשתמש, מוחלף בידי מנוע הצ׳אט (SillyTavern).',
  'ai.thinkingLive': 'חושב… {{secs}}',
  'ai.streamLive': '{{tokens}} טוקנים · {{secs}}',
  'dialog.ok': 'אישור',
  'editor.extensions': 'הרחבות (JSON)',
  'editor.extensionsHint': 'אובייקט ה-`extensions` הגולמי של הכרטיס — JSON. עריכתו עלולה לשבור תכונות של SillyTavern.',
  'editor.extensionsParseError': 'JSON לא תקין — ההרחבות התקפות האחרונות נשמרות.',
  'editor.cardTokenTotal': '~{{tokens}} טוקנים · {{chars}} תווים',
  'dialog.cancel': 'ביטול',
  'dialog.delete': 'מחיקה',
  'ai.translateTitle': 'תרגום הכרטיס',
  'ai.translateMessage': 'לאיזו שפה לתרגם את הכרטיס?',
  'ai.toneTitle': 'שינוי טון',
  'ai.toneMessage': 'באיזה טון לכתוב מחדש את התיאור?',
  'batch.deleteTitle': 'למחוק {{count}} כרטיסים?',
  'settings.clearTitle': 'למחוק את כל הנתונים?',
  ...
  'wizard.language.en': 'אנגלית',
  'wizard.language.fr': 'צרפתית',
  'wizard.language.de': 'גרמנית',
  'wizard.language.ja': 'יפנית',
  'wizard.language.it': 'איטלקית',
  'wizard.language.pl': 'פולנית',
  'wizard.language.tr': 'טורקית',
  'wizard.language.nl': 'הולנדית',
  'wizard.language.uk': 'אוקראינית',
  'wizard.language.vi': 'וייטנאמית',
  'wizard.language.id': 'אינדונזית',
  'wizard.language.hi': 'הינדי',
  'wizard.language.ar': 'ערבית',
  'wizard.language.he': 'עברית',
  'wizard.language.fa': 'פרסית',
  'wizard.language.ro': 'רומנית',
  'wizard.language.cs': 'צ׳כית',
  'wizard.language.sv': 'שוודית',
  'wizard.language.th': 'תאית',
  'wizard.language.pt-pt': 'פורטוגזית (פורטוגל)',
  'wizard.language.tl': 'פיליפינית',
  'search.results': '{{count}} כרטיסים מתאימים',
  'search.capped': 'מוצגות {{count}} ההתאמות הראשונות — חדדו את החיפוש',
  'shortcuts.palette': 'לוח פקודות',
  'library.reorderHandle': 'שינוי סדר הכרטיס (מקשי חצים למעלה/למטה)',
  'palette.title': 'לוח פקודות',
  'palette.placeholder': 'חיפוש כרטיסים, שדות או הרצת פקודה...',
  'palette.hint': '↑↓ ניווט · Enter הרצה · Esc סגירה',
  'palette.empty': 'אין כרטיס, שדה או פעולה מתאימים',
  'palette.jumpTo': 'מעבר אל {{field}}',
  'palette.kind.card': 'כרטיס',
  'palette.kind.field': 'שדה',
  'palette.kind.action': 'פעולה',
  'toast.cardsRestored': '{{count}} כרטיסים שוחזרו',
  'history.title': 'היסטוריית גרסאות',
  'history.empty': 'אין עדיין גרסאות קודמות.',
  'history.compare': 'השווה לגרסה הנוכחית',
  'history.restore': 'שחזור',
  'history.restored': 'הגרסה שוחזרה',
  'history.comparePrefix': 'שינויים מאז ',
  'health.title': 'מצב הכרטיס',
  'health.ok': 'לא נמצאו בעיות.',
  'health.noName': 'לכרטיס אין שם.',
  'health.longName': 'השם באורך {{length}} תווים — ממשקים מסוימים חותכים אחרי 50.',
  'health.noDescription': 'לכרטיס אין תיאור.',
  'health.noFirstMes': 'לכרטיס אין הודעת פתיחה וגם לא ברכה חלופית.',
  'health.noTags': 'אין תגיות, ולכן אי אפשר למצוא את הכרטיס דרך סינון התגיות.',
  'health.unknownMacros': 'מקרואים לא מוכרים יישלחו למודל כפי שהם: {{names}}.',
  'health.unbalancedMacros': 'סוגריים לא מאוזנים במקרו: {{open}} פותחים מול {{close}} סוגרים.',
  'health.greetingBudget': 'סך הברכות הוא {{tokens}} טוקנים, מעבר למגבלת הפלט {{max}}.',
  'health.noSpec': 'לא הוגדרה גרסת spec — הכרטיס ייוצא כ-v2.',
  'health.noImage': 'אין תמונת אווטאר.',
  'health.loreNoKey': 'ל-{{count}} רשומות לורבוק אין מילת מפתח והן אינן קבועות, ולכן לעולם לא יופעלו.',
  'health.loreNoContent': 'ל-{{count}} רשומות לורבוק אין תוכן.',
  'health.loreDuplicateKeys': 'מילות מפתח כפולות בלורבוק: {{keys}}.',
  'health.loreActive': '{{count}} רשומות לורבוק מופעלות מהכרטיס הזה בלבד; השאר זקוקות לטקסט שיחה.',
  'palette.results': 'תוצאות',
  'toast.langOffline': 'ערכת השפה הזו עדיין לא זמינה במצב לא מקוון — מוצגת אנגלית. היא תיטען בפעם הבאה שתהיו מחוברים.',
};
