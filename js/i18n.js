...
translations.en = {
  ...
  'settings.themeColorPlaceholder': '#9147FF',
  ...
  'settings.resetPrompts': 'Reset prompts',
  'settings.promptHint': 'Custom text replaces the reusable instruction section; dynamic card details are still added automatically.',
